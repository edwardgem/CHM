...
<%	int iRole = Integer.parseInt(request.getParameter("role"));
	...
	if (app.equals("CR"))
		isCRAPP = true;
	else if (app.equals("OMF") || app.equalsIgnoreCase("meetwe"))
		isOMFAPP = true;
	...
	if (!isOMFAPP) {
		...
		// review
		if (((iRole & user.iROLE_VENDOR) == 0) && app.equals("PRM") && false) {
    		out.print("<td><a href='../project/review.jsp' onMouseOut=\"MM_swapImgRestore()\" onMouseOver=\"MM_swapImage('review','','../i/but/reviewn.gif',1)\"><img src='../i/but/reviewf.gif' border='0' name='review'></a></td>");
		}
	}
    ...
    out.print("<td><a href='../ep/ep1.jsp' onMouseOut=\"MM_swapImgRestore()\" onMouseOver=\"MM_swapImage('Image2','','../i/but/prfn.gif',1)\"><img src='../i/but/prf.gif' border='0' name='Image2'></a></td>");
