...
/////////////////////////////////////////////////////////////////////
//
//	File: popProjectTaskInsert.jsp
//	Author: Lian Lee
//	Date: 03/20/03
//	Description: Page to insert a new project task.
//
//
//	Modification:
//
...
<%
	...
	String prelevelInfo = request.getParameter("prelevelInfo");
	// Get project task
	...
	Object [] pOrder = (Object [])rProjectTask.get("Order");
	int order = ((Integer)pOrder[0]).intValue();

System.out.println("order: " + order);

	String levelInfo1 = "";
	if (prelevelInfo.length() > 0)
	{
		prelevelInfo = prelevelInfo + ".";
	}
	if (order == 0)
	{
		levelInfo1 = prelevelInfo + "??";
	}
	else
	{
		levelInfo1 = prelevelInfo + order + ".1";
	}
...
function checkEmpty()
{
	path = document.insertProjectTask;
...
function reset()
{
	document.insertProjectTask.Name.value="";
}
...
<table width="660" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>
      <table width="675" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="675" height="60"><img src="../i/top/top_InsertPlan.gif" width="675" height="60" border="0"></td>
        </tr>
      </table>
    </td>
  </tr>
  <tr>
    <td>
	<!-- Content Table -->
		<form method="post" name="insertProjectTask" action="postProjectTaskInsert.jsp">
		...
		<tr>
			...
			<td colspan="3">* Please type in the new task and click submit to proceed.</td>
			<td>&nbsp;</td>
		</tr>
		<tr>
            <td>&nbsp;</td>
			<td width="80" class="td_all">Task Title: &nbsp;</td>
            <td width="6">&nbsp;</td>
            <td width="350"><input type="text" name="Name" value="" size="40"></td>
			<td>&nbsp;</td>
        </tr>
		<tr>
            <td>&nbsp;</td>
			<td width="80" class="td_all">Insert To: &nbsp;</td>
            <td width="6">&nbsp;</td>
            <td width="350"><%=levelInfo%>
            	<input type="hidden" name="insetUnder" value="<%=levelInfo%>">
		 ...
		 <tr>
	        ...
	        <td colspan="2" align="center">
              <table border="0" cellspacing="1" cellpadding="0">
                <tr>
                  <td width="69"><a href="javascript:document.insertProjectTask.submit();" OnClick="return checkEmpty()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image1','','../i/but/sven.gif',1)"><img src="../i/but/svef.gif" border="0" name="Image1"></a></td>
