...
<table>
	...
	<table border="0" width="100%" cellspacing="0" cellpadding="0">
		<tr>
			...
			<font size=+1>MeetWE enables multiple users to chat in a meeting
				<br>but still ensures the meeting facilitator to control the flow</font>
			</td>
		</tr>
		...
		<tr>
			...
			<table border="0" cellspacing="0" cellpadding="0"><tr>
				<td><img src="../i/chat.gif" border="0"></td>
			</tr></table>
			</td>
		</tr>
