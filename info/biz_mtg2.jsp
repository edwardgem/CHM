...
//	Date:	11/01/06
//	Description:
//		Describe business meeting (running a meeting).
//	Modification:
//
//
////////////////////////////////////////////////////////////////////
...
<table>
	...
	<table border="0" width="100%" cellspacing="0" cellpadding="0">
		<tr>
			<td colspan='2' class='headlnk_blue' align='center' width='700'>
			<font size=+1>At the specified time, you click the meeting on the event calendar
				<br>and Run the Meeting on MeetWE</font>
			</td>
		</tr>
		...
		<tr>
			<td colspan='2'>
			<table border="0" cellspacing="0" cellpadding="0"><tr>
				<td class='headlnk_dark' width='600'><img src="../i/spacer.gif" width='10' height='1'>
					Whether you are meeting online or offline,<br>
					<img src='../i/spacer.gif' height='1' width='80'>doing teleconferencing or Net Meeting,<br>
					<img src='../i/spacer.gif' height='1' width='160'>MeetWE improves your team interactions,<br>
					<img src='../i/spacer.gif' height='1' width='80'>helps you to keep an organized record,<br>
					<img src='../i/spacer.gif' height='1' width='160'>and tracks on-going action items and decisions.
				</td>
				<td colspan='2'><img src='../i/spacer.gif' height='1' width='15'>
			</tr></table>
			</td>
		</tr>
