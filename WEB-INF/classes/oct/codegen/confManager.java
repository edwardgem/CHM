...
/////////////////////////////////////////////////////////////////////
//
//  File:   confManager.java
//  Author: FastPath CodeGen Engine
//  Date:   06.16.2006
//  Desciption:
//    This is a class that represent the container of conf classes.
//
//  Modification:
...
/////////////////////////////////////////////////////////////////////
//
// confManager.java : For conf object container manipulation
//
...
import java.util.*;
 ...
 /**
  *
  * <b>General Description:</b>  confManager extends PstManager.  This class
  * manages all conf objects such as creating, retrieving, saving, and
  * deleting conf objects.
  *
  * confManager can only instantiated through the getInstance() method.
  *
  *
...
public class confManager extends oct.pst.PstManager

{
    public static final String NAME = "conf";     // The orgname of Object conf
    public static final String CLASSNAME = "oct.codegen.conf";     // The className of Object conf

    private static confManager manager = null;


    /**
     * Construct an empty conf object
     * @param userObj A PstUserAbstractObject.
     */
    private confManager(PstUserAbstractObject userObj)
    ...
    /**
     * Instantiates a confManager object.
     * @return A confManager.
     */
        ...
        throws PmpManagerCreationException, PmpInternalException
    {
        if(manager == null)
        {
            manager = new confManager(PstSystem.getInstance());
        }
        return manager;
    }//End getInstance
     ...
     * @param userObj The PstUserAbstractObject who is requesting to create a conf.
     * @param type The type of conf to create.<br>
     * @param confName The name of the conf.
     *
     * @exception PmpObjectCreationException There was an error creating the conf.
     * @exception PmpIllegalTypeException The specified compnaytype is invalid.
     * @return The data object that was created.  An explicit cast is required to convert to a conf object.
     */
    public PstAbstractObject create(PstUserAbstractObject userObj, String confName)
        throws PmpIllegalTypeException, PmpObjectCreationException
    {
        return create(userObj.getSession(), confName);
    }//End create
     ...
     * @param confName The name of the conf.
     * @exception PmpObjectCreationException There was an error creating the conf.
     * @exception PmpIllegalTypeException The specified conf type is invalid.
     * @return The data object that was created.  An explicit cast is required to convert to a conf object.
     */
    PstAbstractObject create(OmsSession session, String confName)
        throws PmpIllegalTypeException, PmpObjectCreationException
    {
        conf conf = null;
        if(confName == null || confName.length() == 0)
        {
            throw new PmpObjectCreationException("The conf name cannot be empty.");
        }

        try
        {

            conf = new conf(session,m_organization, confName);
            return conf;
        }
        catch(PmpException pe)
        {
            ...
            throw new PmpObjectCreationException("Error creating conf object:" + pe.toString());
        }
    }//End create
    	...
    	throws PmpObjectCreationException, PmpInternalException
    {
		...
		try
		{
			newUser = new conf(userObj, m_organization, memberName, password);
		}
		catch(PmpException e)
		{
			throw new PmpObjectCreationException("Cannot create new conf");
		}
    	...
    	throws PmpObjectCreationException, PmpInternalException
    {
		...
		try
		{
			newUser = new conf(userObj, m_organization);
		}
		catch(PmpException e)
		{
			throw new PmpObjectCreationException("Cannot create new conf");
    ...
    /**
     *
     * Obtain a conf object from database.
     * @param userObj  PstUserAbstractObject requesting a conf object.
     * @param objectId Object id of the conf object.
     ...
     * @return The data object with the specified id.  An explicit cast is required to convert to a conf object.
     */
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        try
        {
            ...
            {
                throw new PmpObjectNotFoundException("Member not in conf organization.");
            }

            //Return a conf object
            return new conf(member);
        }
    ...
    /**
     *
     * Obtain a conf object from the database.
     * @param userObj  A PstUserAbstractObject.
     * @param objectName Object name of the conf object.
     * @exception PmpObjectNotFoundException Could not find the specified object.
     * @exception PmpInternalException An internal error occurred.
     * @return The data object with the specified id.  An explicit cast is required to convert to a conf object.
     */
    ...
    /**
     *
     * Obtain an array of conf objects based on a set of specified object ids.
     * @param userObj  PstUserAbstractObject requesting the conf objects.
     * @param objectIds Object ids in an int array of all conf objects to retrieve.
     ...
     *  the data object to a conf object.
     *   <b>NOTE:</b>  The arrays of conf will be sorted by object ids,
     ...
     * Obtain an array of conf objects based on a set of specified object ids.
     * @param userObj  PstUserAbstractObject requesting the conf objects.
     * @param objectIds Object ids in an Integer array of all conf objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a conf object.
    ...
    /**
     *
     * Obtain a Company object based on a set of conf ids.
     * Obtain an array of conf objects based on a set of specified object ids.
     * @param session  PstUserAbstractObject requesting the conf objects.
     * @param objectIds Object ids of all conf objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a conf object.
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        try
        {
            ...
            conf [] result = new conf[newCount];

            for(int i=0; i<newCount; i++)
            {
                OmsMember member = (OmsMember) memList.get(i);
                //Return a conf object
                result[i] = new conf(member);
    ...
    /**
     *
     * Obtain an array of conf objects based on a set of specified conf member names.
     * @param userObj  PstUserAbstractObject requesting the conf objects.
     * @param objectNames Object names of all conf objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a conf object.
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        ...
        conf [] newResult = new conf[newCount];
        for(int i=0; i<newCount; i++)
        {
            newResult[i] = (conf) result.get(i);
        }
     ...
     * @param dataObject The conf object to delete permanently.
     ...
     * @param dataObject The conf object to save.
     ...
     * @param dataObject The conf object to refresh.
     */
    public void refresh(PstAbstractObject dataObject)
    {
        ((conf)dataObject).refresh();
    ...
    /**
     * Obtain a List of conf objects that belongs to the conf.
     *
     * @param userObj - PstUserAbstractObject requesting the conf objects.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An List of conf objects that is own by this user.
     *
     */
    public PstAbstractObject [] getAllconf(PstUserAbstractObject userObj)
        throws PmpObjectNotFoundException, PmpInternalException
    {
