...
//  Date:   06.16.2006
//  Description:
//    This is a class that represent the container of event classes.
//
//  Modification:
//		@030904ECC	Created template file for class representation of OMM Organization.
//		@ECC101707	Adopted to implement event.
//
/////////////////////////////////////////////////////////////////////
//
// eventManager.java : For event object container manipulation
//
...
import util.PrmLog;
 ...
 /**
  *
  * <b>General Description:</b>  eventManager extends PstManager.  This class
  * manages all event objects such as creating, retrieving, saving, and
  * deleting event objects.
  *
  * eventManager can only instantiated through the getInstance() method.
  *
  *
...
public class eventManager extends oct.pst.PstManager

{
	private static Logger l 				= PrmLog.getLog();

	public static final String NAME			= "event";     // The orgname of Object event
    public static final String CLASSNAME	= "oct.codegen.event";     // The className of Object event
    ...
    /**
     * Construct an empty event object
     * @param userObj A PstUserAbstractObject.
     */
    private eventManager(PstUserAbstractObject userObj)
    ...
    /**
     * Instantiates a eventManager object.
        ...
        throws PmpManagerCreationException, PmpInternalException
    {
        if(manager == null)
        {
            manager = new eventManager(PstSystem.getInstance());
        }
        return manager;
    }//End getInstance
     ...
     * @param userObj The PstUserAbstractObject who is requesting to create a event.
     * @param type The type of event to create.<br>
     * @param eventName The name of the event.
     *
     * @exception PmpObjectCreationException There was an error creating the event.
     * @exception PmpIllegalTypeException The specified compnaytype is invalid.
     * @return The data object that was created.  An explicit cast is required to convert to a event object.
     */
    public PstAbstractObject create(PstUserAbstractObject userObj, String eventName)
        throws PmpIllegalTypeException, PmpObjectCreationException
    {
        return create(userObj.getSession(), eventName);
    }//End create
     ...
     * @param eventName The name of the event.
     * @exception PmpObjectCreationException There was an error creating the event.
     * @exception PmpIllegalTypeException The specified event type is invalid.
     * @return The data object that was created.  An explicit cast is required to convert to a event object.
     */
    PstAbstractObject create(OmsSession session, String eventName)
        throws PmpIllegalTypeException, PmpObjectCreationException
    {
        event event = null;
        if(eventName == null || eventName.length() == 0)
        {
            throw new PmpObjectCreationException("The event name cannot be empty.");
        }

        try
        {

            event = new event(session,m_organization, eventName);
            return event;
        }
        catch(PmpException pe)
        {
            ...
            throw new PmpObjectCreationException("Error creating event object:" + pe.toString());
        }
    }//End create
    	...
    	throws PmpObjectCreationException, PmpInternalException
    {
		...
		try
		{
			newUser = new event(userObj, m_organization, memberName, password);
		}
		catch(PmpException e)
		{
			throw new PmpObjectCreationException("Cannot create new event");
		}
    	...
    	throws PmpObjectCreationException, PmpInternalException
    {
		...
		try
		{
			newEvt = new event(userObj, m_organization);
		}
		catch(PmpException e)
		{
			throw new PmpObjectCreationException("Cannot create new event");
    ...
    /**
     *
     * Obtain a event object from database.
     * @param userObj  PstUserAbstractObject requesting a event object.
     * @param objectId Object id of the event object.
     ...
     * @return The data object with the specified id.  An explicit cast is required to convert to a event object.
     */
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        try
        {
            ...
            {
                throw new PmpObjectNotFoundException("Member not in event organization.");
            }

            //Return a event object
            return new event(member);
        }
    ...
    /**
     *
     * Obtain a event object from the database.
     * @param userObj  A PstUserAbstractObject.
     * @param objectName Object name of the event object.
     * @exception PmpObjectNotFoundException Could not find the specified object.
     * @exception PmpInternalException An internal error occurred.
     * @return The data object with the specified id.  An explicit cast is required to convert to a event object.
     */
    ...
    /**
     *
     * Obtain an array of event objects based on a set of specified object ids.
     * @param userObj  PstUserAbstractObject requesting the event objects.
     * @param objectIds Object ids in an int array of all event objects to retrieve.
     ...
     *  the data object to a event object.
     *   <b>NOTE:</b>  The arrays of event will be sorted by object ids,
     ...
     * Obtain an array of event objects based on a set of specified object ids.
     * @param userObj  PstUserAbstractObject requesting the event objects.
     * @param objectIds Object ids in an Integer array of all event objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a event object.
    ...
    /**
     *
     * Obtain a Company object based on a set of event ids.
     * Obtain an array of event objects based on a set of specified object ids.
     * @param session  PstUserAbstractObject requesting the event objects.
     * @param objectIds Object ids of all event objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a event object.
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        try
        {
            ...
            event [] result = new event[newCount];

            for(int i=0; i<newCount; i++)
            {
                OmsMember member = (OmsMember) memList.get(i);
                //Return a event object
                result[i] = new event(member);
    ...
    /**
     *
     * Obtain an array of event objects based on a set of specified event member names.
     * @param userObj  PstUserAbstractObject requesting the event objects.
     * @param objectNames Object names of all event objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a event object.
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        ...
        event [] newResult = new event[newCount];
        for(int i=0; i<newCount; i++)
        {
            newResult[i] = (event) result.get(i);
        }
     ...
     * @param dataObject The event object to delete permanently.
     ...
     * @param dataObject The event object to save.
     ...
     * @param dataObject The event object to refresh.
     */
    public void refresh(PstAbstractObject dataObject)
    {
        ((event)dataObject).refresh();
    ...
    /**
     * Obtain a List of event objects that belongs to the event.
     *
     * @param userObj - PstUserAbstractObject requesting the event objects.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An List of event objects that is own by this user.
     *
     */
    public PstAbstractObject [] getAllevent(PstUserAbstractObject userObj)
        throws PmpObjectNotFoundException, PmpInternalException
    {
