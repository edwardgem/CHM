...
//  Date:   03.18.2004
//  Description:
//    This is a class that represent the container of action classes.
//
//  Modification:
...
/////////////////////////////////////////////////////////////////////
//
// actionManager.java : For action object container manipulation
//
...
import oct.pst.PstUserAbstractObject;
 ...
 /**
  *
  * <b>General Description:</b>  actionManager extends PstManager.  This class
  * manages all action objects such as creating, retrieving, saving, and
  * deleting action objects.
  *
  * actionManager can only instantiated through the getInstance() method.
  *
  *
...
public class actionManager extends oct.pst.PstManager

{
    public static final String NAME = "action";     // The orgname of Object action
    public static final String CLASSNAME = "oct.codegen.action";     // The className of Object action

    private static actionManager manager = null;


    /**
     * Construct an empty action object
     * @param userObj A PstUserAbstractObject.
     */
    private actionManager(PstUserAbstractObject userObj)
    ...
    /**
     * Instantiates a actionManager object.
        ...
        throws PmpManagerCreationException, PmpInternalException
    {
        if(manager == null)
        {
            manager = new actionManager(PstSystem.getInstance());
        }
        return manager;
    }//End getInstance
     ...
     * @param userObj The PstUserAbstractObject who is requesting to create a action.
     * @param type The type of action to create.<br>
     * @param actionName The name of the action.
     *
     * @exception PmpObjectCreationException There was an error creating the action.
     * @exception PmpIllegalTypeException The specified compnaytype is invalid.
     * @return The data object that was created.  An explicit cast is required to convert to a action object.
     */
    public PstAbstractObject create(PstUserAbstractObject userObj, String actionName)
        throws PmpIllegalTypeException, PmpObjectCreationException
    {
        return create(userObj.getSession(), actionName);
    }//End create
     ...
     * @param actionName The name of the action.
     * @exception PmpObjectCreationException There was an error creating the action.
     * @exception PmpIllegalTypeException The specified action type is invalid.
     * @return The data object that was created.  An explicit cast is required to convert to a action object.
     */
    PstAbstractObject create(OmsSession session, String actionName)
        throws PmpIllegalTypeException, PmpObjectCreationException
    {
        action action = null;
        if(actionName == null || actionName.length() == 0)
        {
            throw new PmpObjectCreationException("The action name cannot be empty.");
        }

        try
        {

            action = new action(session,m_organization, actionName);
            return action;
        }
        catch(PmpException pe)
        {
            throw new PmpObjectCreationException("Error creating action object:" + pe.toString());
        }
    }//End create
    	...
    	throws PmpObjectCreationException, PmpInternalException
    {
		...
		try
		{
			newUser = new action(userObj, m_organization, memberName, password);
		}
		catch(PmpException e)
		{
			throw new PmpObjectCreationException("Cannot create new action");
		}
    	...
    	throws PmpObjectCreationException, PmpInternalException
    {
		...
		try
		{
			// new action() will create an action step
			newUser = new action(userObj, m_organization);
		}
		catch(PmpException e)
		{
			throw new PmpObjectCreationException("Cannot create new action");
    ...
    /**
     *
     * Obtain a action object from database.
     * @param userObj  PstUserAbstractObject requesting a action object.
     * @param objectId Object id of the action object.
     ...
     * @return The data object with the specified id.  An explicit cast is required to convert to a action object.
     */
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        try
        {
            ...
            {
                throw new PmpObjectNotFoundException("Member not in action organization.");
            }
    ...
    /**
     *
     * Obtain a action object from the database.
     * @param userObj  A PstUserAbstractObject.
     * @param objectName Object name of the action object.
     * @exception PmpObjectNotFoundException Could not find the specified object.
     * @exception PmpInternalException An internal error occurred.
     * @return The data object with the specified id.  An explicit cast is required to convert to a action object.
     */
    ...
    /**
     *
     * Obtain an array of action objects based on a set of specified object ids.
     * @param userObj  PstUserAbstractObject requesting the action objects.
     * @param objectIds Object ids in an int array of all action objects to retrieve.
     ...
     *  the data object to a action object.
     *   <b>NOTE:</b>  The arrays of action will be sorted by object ids,
     ...
     * Obtain an array of action objects based on a set of specified object ids.
     * @param userObj  PstUserAbstractObject requesting the action objects.
     * @param objectIds Object ids in an Integer array of all action objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a action object.
    ...
    /**
     *
     * Obtain a Company object based on a set of action ids.
     * Obtain an array of action objects based on a set of specified object ids.
     * @param session  PstUserAbstractObject requesting the action objects.
     * @param objectIds Object ids of all action objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a action object.
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        try
        {
            ...
            action [] result = new action[newCount];

            for(int i=0; i<newCount; i++)
            {
                OmsMember member = (OmsMember) memList.get(i);
                //Return a action object
                result[i] = new action(member);
    ...
    /**
     *
     * Obtain an array of action objects based on a set of specified action member names.
     * @param userObj  PstUserAbstractObject requesting the action objects.
     * @param objectNames Object names of all action objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a action object.
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        ...
        action [] newResult = new action[newCount];
        for(int i=0; i<newCount; i++)
        {
            newResult[i] = (action) result.get(i);
        }
     ...
     * @param dataObject The action object to delete permanently.
     ...
     * @param dataObject The action object to save.
     ...
     * @param dataObject The action object to refresh.
     */
    public void refresh(PstAbstractObject dataObject)
    {
        ((action)dataObject).refresh();
    ...
    /**
     * Obtain a List of action objects that belongs to the action.
     *
     * @param userObj - PstUserAbstractObject requesting the action objects.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An List of action objects that is own by this user.
     *
     */
    public PstAbstractObject [] getAllaction(PstUserAbstractObject userObj)
        throws PmpObjectNotFoundException, PmpInternalException
    {
