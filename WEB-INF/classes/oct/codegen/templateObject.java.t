...
//  Date:   06.16.2006
//  Description:
//		Implementation of $templateObject$ class
//  Modification:
...
/////////////////////////////////////////////////////////////////////
//
// $templateObject$.java : implementation of the $templateObject$ class
//
...
/**
*
* <b>General Description:</b>  $templateObject$ extends PmpAbstractObject.  This class
* encapsulates the data of a member from the "$templateObject$" organization.
*
* The $templateObject$ class provides a facility to modify data of an existing $templateObject$ object.
*
*
*
* <b>Class Dependencies:</b>
*   oct.custom.$templateObject$Manager
*   oct.pmp.PmpUser
...
public class $templateObject$ extends PstAbstractObject

{
    ...
    static $templateObject$Manager manager;

    /**
     * Constructor for instantiating a new $templateObject$.
     * @param member An OmsMember representing a $templateObject$.
     */
    public $templateObject$(OmsMember member)
    {
        super(member);
        try
        {
            manager = $templateObject$Manager.getInstance();
        }
        catch(PmpException pe)
        {
            //throw new PmpInternalException("Error getting $templateObject$Manager instance.");
        }
    }//End Constructor
     ...
     */
	$templateObject$(PstUserAbstractObject userObj, OmsOrganization org, String memberName, String password)
		throws PmpException
	{
    ...
    /**
     * Constructor for creating a $templateObject$.  Used by $templateObject$Manager.
     * @param userObj A PmpUser.
     * @param org The OmsOrganization for the $templateObject$.
     */
    $templateObject$(PstUserAbstractObject userObj, OmsOrganization org)
    ...
    /**
     * Constructor for creating a $templateObject$.
     * @param session An OmsSession.
     * @param org The OmsOrganization for the $templateObject$.
     */
    $templateObject$(OmsSession session, OmsOrganization org)
        throws PmpObjectCreationException, PmpInternalException
    {
        super(session, org, "");
         try
    ...
    /**
     * Constructor for creating a $templateObject$ using a member name.
     * @param userObj A PmpUser.
     * @param org The OmsOrganization for the $templateObject$.
     * @param $templateObject$MemName The member name for the created $templateObject$.
     */
    $templateObject$(PstUserAbstractObject userObj, OmsOrganization org, String $templateObject$MemName)
        throws PmpObjectCreationException, PmpInternalException
    {
        super(userObj, org, $templateObject$MemName, null);
        try
        {
          manager = $templateObject$Manager.getInstance();
        }
     ...
     * @param session An OmsSession.
     * @param org The OmsOrganization for the $templateObject$.
     * @param companyMemberName The member name for the created $templateObject$.
     */
    $templateObject$(OmsSession session, OmsOrganization org, String $templateObject$MemName)
        throws PmpObjectCreationException, PmpInternalException
    {
        super(session, org, $templateObject$MemName, null);
        try
        {
           manager = $templateObject$Manager.getInstance();
        }
