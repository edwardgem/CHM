...
public class GetPepEmployeePicture extends HttpServlet
{
   /**
   * Handle GET requests
   */
   ...
   */
   ...
   public void getImage(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
   {
        ...
        try
        {
			...
			PepEmployeeManager objMgr = PepEmployeeManager.getInstance();
	  		PepEmployee obj = (PepEmployee)objMgr.get(user, objName);
