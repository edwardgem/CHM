...
/////////////////////////////////////////////////////////////////////
//
//  File:   userinfoManager.java
//  Author: FastPath CodeGen Engine
//  Date:   03.18.2004
//  Description:
//    This is a class that represent the container of userinfo classes.
//
//  Modification:
...
/////////////////////////////////////////////////////////////////////
//
// userinfoManager.java : For userinfo object container manipulation
//
...
import oct.pst.PstUserAbstractObject;
 ...
 /**
  *
  * <b>General Description:</b>  userinfoManager extends PstManager.  This class
  * manages all userinfo objects such as creating, retrieving, saving, and
  * deleting userinfo objects.
  *
  * userinfoManager can only instantiated through the getInstance() method.
  *
  *
  * <b>Class Dependencies:</b>
  *   oct.codegen.userinfo
...
public class userinfoManager extends oct.pst.PstManager

{
    public static final String NAME = "userinfo";     // The orgname of Object userinfo
    public static final String CLASSNAME = "oct.codegen.userinfo";     // The className of Object userinfo

    private static userinfoManager manager = null;


    /**
     * Construct an empty userinfo object
     * @param userObj A PstUserAbstractObject.
     */
    private userinfoManager(PstUserAbstractObject userObj)
    ...
    /**
     * Instantiates a userinfoManager object.
     * @return A userinfoManager.
     */
        ...
        throws PmpManagerCreationException, PmpInternalException
    {
        if(manager == null)
        {
            manager = new userinfoManager(PstSystem.getInstance());
        }
        return manager;
    }//End getInstance
     ...
     * @param userObj The PstUserAbstractObject who is requesting to create a userinfo.
     * @param type The type of userinfo to create.<br>
     * @param userinfoName The name of the userinfo.
     *
     * @exception PmpObjectCreationException There was an error creating the userinfo.
     * @exception PmpIllegalTypeException The specified compnaytype is invalid.
     * @return The data object that was created.  An explicit cast is required to convert to a userinfo object.
     */
    public PstAbstractObject create(PstUserAbstractObject userObj, String userinfoName)
        throws PmpIllegalTypeException, PmpObjectCreationException
    {
        return create(userObj.getSession(), userinfoName);
    }//End create
     ...
     * @param userinfoName The name of the userinfo.
     * @exception PmpObjectCreationException There was an error creating the userinfo.
     * @exception PmpIllegalTypeException The specified userinfo type is invalid.
     * @return The data object that was created.  An explicit cast is required to convert to a userinfo object.
     */
    PstAbstractObject create(OmsSession session, String userinfoName)
        throws PmpIllegalTypeException, PmpObjectCreationException
    {
        userinfo userinfo = null;
        if(userinfoName == null || userinfoName.length() == 0)
        {
            throw new PmpObjectCreationException("The userinfo name cannot be empty.");
        }

        try
        {

            userinfo = new userinfo(session,m_organization, userinfoName);
            return userinfo;
        }
        catch(PmpException pe)
        {
            ...
            throw new PmpObjectCreationException("Error creating userinfo object:" + pe.toString());
        }
    }//End create
    	...
    	throws PmpObjectCreationException, PmpInternalException
    {
		...
		try
		{
			newUser = new userinfo(userObj, m_organization, memberName, password);
		}
		catch(PmpException e)
		{
			throw new PmpObjectCreationException("Cannot create new userinfo");
		}
    	...
    	throws PmpObjectCreationException, PmpInternalException
    {
		...
		try
		{
			newUser = new userinfo(userObj, m_organization);
		}
		catch(PmpException e)
		{
			throw new PmpObjectCreationException("Cannot create new userinfo");
    ...
    /**
     *
     * Obtain a userinfo object from database.
     * @param userObj  PstUserAbstractObject requesting a userinfo object.
     * @param objectId Object id of the userinfo object.
     ...
     * @return The data object with the specified id.  An explicit cast is required to convert to a userinfo object.
     */
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        try
        {
            ...
            {
                throw new PmpObjectNotFoundException("Member not in userinfo organization.");
            }
    ...
    /**
     *
     * Obtain a userinfo object from the database.
     * @param userObj  A PstUserAbstractObject.
     * @param objectName Object name of the userinfo object.
     * @exception PmpObjectNotFoundException Could not find the specified object.
     * @exception PmpInternalException An internal error occurred.
     * @return The data object with the specified id.  An explicit cast is required to convert to a userinfo object.
     */
    ...
    /**
     *
     * Obtain an array of userinfo objects based on a set of specified object ids.
     * @param userObj  PstUserAbstractObject requesting the userinfo objects.
     * @param objectIds Object ids in an int array of all userinfo objects to retrieve.
     ...
     *  the data object to a userinfo object.
     *   <b>NOTE:</b>  The arrays of userinfo will be sorted by object ids,
     ...
     * Obtain an array of userinfo objects based on a set of specified object ids.
     * @param userObj  PstUserAbstractObject requesting the userinfo objects.
     * @param objectIds Object ids in an Integer array of all userinfo objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a userinfo object.
    ...
    /**
     *
     * Obtain a Company object based on a set of userinfo ids.
     * Obtain an array of userinfo objects based on a set of specified object ids.
     * @param session  PstUserAbstractObject requesting the userinfo objects.
     * @param objectIds Object ids of all userinfo objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a userinfo object.
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        try
        {
            ...
            userinfo [] result = new userinfo[newCount];

            for(int i=0; i<newCount; i++)
            {
                OmsMember member = (OmsMember) memList.get(i);
                //Return a userinfo object
                result[i] = new userinfo(member);
    ...
    /**
     *
     * Obtain an array of userinfo objects based on a set of specified userinfo member names.
     * @param userObj  PstUserAbstractObject requesting the userinfo objects.
     * @param objectNames Object names of all userinfo objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a userinfo object.
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        ...
        userinfo [] newResult = new userinfo[newCount];
        for(int i=0; i<newCount; i++)
        {
            newResult[i] = (userinfo) result.get(i);
        }
     ...
     * @param dataObject The userinfo object to delete permanently.
     ...
     * @param dataObject The userinfo object to save.
     ...
     * @param dataObject The userinfo object to refresh.
     */
    public void refresh(PstAbstractObject dataObject)
    {
        ((userinfo)dataObject).refresh();
    ...
    /**
     * Obtain a List of userinfo objects that belongs to the userinfo.
     *
     * @param userObj - PstUserAbstractObject requesting the userinfo objects.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An List of userinfo objects that is own by this user.
     *
     */
    public PstAbstractObject [] getAlluserinfo(PstUserAbstractObject userObj)
        throws PmpObjectNotFoundException, PmpInternalException
    {
