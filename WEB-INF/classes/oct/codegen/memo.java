...
/////////////////////////////////////////////////////////////////////
//
// memo.java : implementation of the memo class
//
...
/**
*
* <b>General Description:</b>  memo extends PmpAbstractObject.  This class
* encapsulates the data of a member from the "memo" organization.
*
* The memo class provides a facility to modify data of an existing memo object.
*
*
*
* <b>Class Dependencies:</b>
*   oct.custom.memoManager
*   oct.pmp.PmpUser
...
public class memo extends PstAbstractObject

{

	// public constants
	public static final String	M_LETTER	= "Letter";
	
    //Private attributes


    static memoManager manager;

    /**
     * Constructor for instantiating a new memo.
     * @param member An OmsMember representing a memo.
     */
    public memo(OmsMember member)
    {
        super(member);
        try
        {
        ...
        {
            //throw new PmpInternalException("Error getting memoManager instance.");
        }
    }//End Constructor
     ...
     */
	memo(PstUserAbstractObject userObj, OmsOrganization org, String memberName, String password)
		throws PmpException
	{
    ...
    /**
     * Constructor for creating a memo.  Used by memoManager.
     * @param userObj A PmpUser.
     * @param org The OmsOrganization for the memo.
     */
    memo(PstUserAbstractObject userObj, OmsOrganization org)
    ...
    /**
     * Constructor for creating a memo.
     * @param session An OmsSession.
     * @param org The OmsOrganization for the memo.
     */
    memo(OmsSession session, OmsOrganization org)
        throws PmpObjectCreationException, PmpInternalException
    {
        super(session, org, "");
         try
    ...
    /**
     * Constructor for creating a memo using a member name.
     * @param userObj A PmpUser.
     * @param org The OmsOrganization for the memo.
     * @param memoMemName The member name for the created memo.
     */
    memo(PstUserAbstractObject userObj, OmsOrganization org, String memoMemName)
        throws PmpObjectCreationException, PmpInternalException
    {
        super(userObj, org, memoMemName, null);
        try
        {
          manager = memoManager.getInstance();
        }
     ...
     * @param session An OmsSession.
     * @param org The OmsOrganization for the memo.
     * @param companyMemberName The member name for the created memo.
     */
    memo(OmsSession session, OmsOrganization org, String memoMemName)
        throws PmpObjectCreationException, PmpInternalException
    {
        super(session, org, memoMemName, null);
        try
        {
           manager = memoManager.getInstance();
        }
