...
//  Date:   06.11.2006
//  Description:
//    This is a class that represent the container of query classes.
//
//  Modification:
...
/////////////////////////////////////////////////////////////////////
//
// queryManager.java : For query object container manipulation
//
...
import oct.pst.PstUserAbstractObject;
 ...
 /**
  *
  * <b>General Description:</b>  queryManager extends PstManager.  This class
  * manages all query objects such as creating, retrieving, saving, and
  * deleting query objects.
  *
  * queryManager can only instantiated through the getInstance() method.
  *
  *
...
public class queryManager extends oct.pst.PstManager

{
    public static final String NAME = "query";     // The orgname of Object query
    public static final String CLASSNAME = "oct.codegen.query";     // The className of Object query
     ...
     */
    private queryManager(PstUserAbstractObject userObj)
    ...
    /**
     * Instantiates a queryManager object.
        ...
        throws PmpManagerCreationException, PmpInternalException
    {
        if(manager == null)
        {
            manager = new queryManager(PstSystem.getInstance());
        }
        return manager;
    }//End getInstance
     ...
     * @param userObj The PstUserAbstractObject who is requesting to create a query.
     * @param type The type of query to create.<br>
     * @param queryName The name of the query.
     *
     * @exception PmpObjectCreationException There was an error creating the query.
     * @exception PmpIllegalTypeException The specified compnaytype is invalid.
     * @return The data object that was created.  An explicit cast is required to convert to a query object.
     */
    public PstAbstractObject create(PstUserAbstractObject userObj, String queryName)
        throws PmpIllegalTypeException, PmpObjectCreationException
    {
        return create(userObj.getSession(), queryName);
    }//End create
     ...
     * @param queryName The name of the query.
     * @exception PmpObjectCreationException There was an error creating the query.
     * @exception PmpIllegalTypeException The specified query type is invalid.
     * @return The data object that was created.  An explicit cast is required to convert to a query object.
     */
    PstAbstractObject create(OmsSession session, String queryName)
        throws PmpIllegalTypeException, PmpObjectCreationException
    {
        query query = null;
        if(queryName == null || queryName.length() == 0)
        {
            throw new PmpObjectCreationException("The query name cannot be empty.");
        }

        try
        {

            query = new query(session,m_organization, queryName);
            return query;
        }
        catch(PmpException pe)
        {
            ...
            throw new PmpObjectCreationException("Error creating query object:" + pe.toString());
        }
    }//End create
    	...
    	throws PmpObjectCreationException, PmpInternalException
    {
		...
		try
		{
			newUser = new query(userObj, m_organization, memberName, password);
		}
		catch(PmpException e)
		{
			throw new PmpObjectCreationException("Cannot create new query");
		}
    	...
    	throws PmpObjectCreationException, PmpInternalException
    {
		...
		try
		{
			newUser = new query(userObj, m_organization);
		}
		catch(PmpException e)
		{
			throw new PmpObjectCreationException("Cannot create new query");
    ...
    /**
     *
     * Obtain a query object from database.
     * @param userObj  PstUserAbstractObject requesting a query object.
     * @param objectId Object id of the query object.
     ...
     * @return The data object with the specified id.  An explicit cast is required to convert to a query object.
     */
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        try
        {
            ...
            {
                throw new PmpObjectNotFoundException("Member not in query organization.");
            }

            //Return a query object
            return new query(member);
        }
    ...
    /**
     *
     * Obtain a query object from the database.
     * @param userObj  A PstUserAbstractObject.
     * @param objectName Object name of the query object.
     * @exception PmpObjectNotFoundException Could not find the specified object.
     * @exception PmpInternalException An internal error occurred.
     * @return The data object with the specified id.  An explicit cast is required to convert to a query object.
     */
    ...
    /**
     *
     * Obtain an array of query objects based on a set of specified object ids.
     * @param userObj  PstUserAbstractObject requesting the query objects.
     * @param objectIds Object ids in an int array of all query objects to retrieve.
     ...
     *  the data object to a query object.
     *   <b>NOTE:</b>  The arrays of query will be sorted by object ids,
     ...
     * Obtain an array of query objects based on a set of specified object ids.
     * @param userObj  PstUserAbstractObject requesting the query objects.
     * @param objectIds Object ids in an Integer array of all query objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a query object.
    ...
    /**
     *
     * Obtain a Company object based on a set of query ids.
     * Obtain an array of query objects based on a set of specified object ids.
     * @param session  PstUserAbstractObject requesting the query objects.
     * @param objectIds Object ids of all query objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a query object.
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        try
        {
            ...
            query [] result = new query[newCount];

            for(int i=0; i<newCount; i++)
            {
                OmsMember member = (OmsMember) memList.get(i);
                //Return a query object
                result[i] = new query(member);
    ...
    /**
     *
     * Obtain an array of query objects based on a set of specified query member names.
     * @param userObj  PstUserAbstractObject requesting the query objects.
     * @param objectNames Object names of all query objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a query object.
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        ...
        query [] newResult = new query[newCount];
        for(int i=0; i<newCount; i++)
        {
            newResult[i] = (query) result.get(i);
        }
     ...
     * @param dataObject The query object to delete permanently.
     ...
     * @param dataObject The query object to save.
     ...
     * @param dataObject The query object to refresh.
     */
    public void refresh(PstAbstractObject dataObject)
    {
        ((query)dataObject).refresh();
    ...
    /**
     * Obtain a List of query objects that belongs to the query.
     *
     * @param userObj - PstUserAbstractObject requesting the query objects.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An List of query objects that is own by this user.
     *
     */
    public PstAbstractObject [] getAllquery(PstUserAbstractObject userObj)
        throws PmpObjectNotFoundException, PmpInternalException
    {
