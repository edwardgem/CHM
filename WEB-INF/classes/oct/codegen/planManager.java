...
/////////////////////////////////////////////////////////////////////
//
//  File:   planManager.java
//  Author: FastPath CodeGen Engine
//  Date:   03.18.2003
//  Description:
//    This is a class that represent the container of plan classes.
//
//  Modification:
...
/////////////////////////////////////////////////////////////////////
//
// planManager.java : For plan object container manipulation
//
...
import oct.pst.PstUserAbstractObject;
 ...
 /**
  *
  * <b>General Description:</b>  planManager extends PstManager.  This class
  * manages all plan objects such as creating, retrieving, saving, and
  * deleting plan objects.
  *
  * planManager can only instantiated through the getInstance() method.
  *
  *
...
public class planManager extends oct.pst.PstManager

{
    public static final String NAME = "plan";     // The orgname of Object plan
    public static final String CLASSNAME = "oct.codegen.plan";     // The className of Object plan

    private static planManager manager = null;


    /**
     * Construct an empty plan object
     * @param user A PstUserAbstractObject.
     */
    private planManager(PstUserAbstractObject user)
    ...
    /**
     * Instantiates a planManager object.
        ...
        throws PmpManagerCreationException, PmpInternalException
    {
        if(manager == null)
        {
            manager = new planManager(PstSystem.getInstance());
        }
        return manager;
    }//End getInstance
     ...
     * @param user The PstUserAbstractObject who is requesting to create a plan.
     * @param type The type of plan to create.<br>
     * @param planName The name of the plan.
     *
     * @exception PmpObjectCreationException There was an error creating the plan.
     * @exception PmpIllegalTypeException The specified compnaytype is invalid.
     * @return The data object that was created.  An explicit cast is required to convert to a plan object.
     */
    public PstAbstractObject create(PstUserAbstractObject user, String planName)
        throws PmpIllegalTypeException, PmpObjectCreationException
    {
        return create(user.getSession(), planName);
    }//End create
     ...
     * @param planName The name of the plan.
     * @exception PmpObjectCreationException There was an error creating the plan.
     * @exception PmpIllegalTypeException The specified plan type is invalid.
     * @return The data object that was created.  An explicit cast is required to convert to a plan object.
     */
    PstAbstractObject create(OmsSession session, String planName)
        throws PmpIllegalTypeException, PmpObjectCreationException
    {
        plan plan = null;
        if(planName == null || planName.length() == 0)
        {
            throw new PmpObjectCreationException("The plan name cannot be empty.");
        }

        try
        {

            plan = new plan(session,m_organization, planName);
            return plan;
        }
        catch(PmpException pe)
        {
            ...
            throw new PmpObjectCreationException("Error creating plan object:" + pe.toString());
        }
    }//End create
    	...
    	throws PmpObjectCreationException, PmpInternalException
    {
		...
		try
		{
			newUser = new plan(user, m_organization, memberName, password);
		}
		catch(PmpException e)
		{
			throw new PmpObjectCreationException("Cannot create new plan");
		}
    	...
    	throws PmpObjectCreationException, PmpInternalException
    {
		...
		try
		{
			newUser = new plan(user, m_organization);
		}
		catch(PmpException e)
		{
			throw new PmpObjectCreationException("Cannot create new plan");
    ...
    /**
     *
     * Obtain a plan object from database.
     * @param user  PstUserAbstractObject requesting a plan object.
     * @param objectId Object id of the plan object.
     ...
     * @return The data object with the specified id.  An explicit cast is required to convert to a plan object.
     */
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        try
        {
            ...
            {
                throw new PmpObjectNotFoundException("Member not in plan organization.");
            }
     ...
     * @param user  A PstUserAbstractObject.
     * @param objectName Object name of the plan object.
     * @exception PmpObjectNotFoundException Could not find the specified object.
     * @exception PmpInternalException An internal error occurred.
     * @return The data object with the specified id.  An explicit cast is required to convert to a plan object.
     */
    ...
    /**
     *
     * Obtain an array of plan objects based on a set of specified object ids.
     * @param user  PstUserAbstractObject requesting the plan objects.
     * @param objectIds Object ids of all plan objects to retrieve.
     ...
     *  the data object to a plan object.
     *   <b>NOTE:</b>  The arrays of plan will be sorted by object ids,
    ...
    /**
     *
     * Obtain a Company object based on a set of plan ids.
     * Obtain an array of plan objects based on a set of specified object ids.
     * @param session  PstUserAbstractObject requesting the plan objects.
     * @param objectIds Object ids of all plan objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        try
        {
            ...
            plan [] result = new plan[newCount];

            for(int i=0; i<newCount; i++)
            {
                OmsMember member = (OmsMember) memList.get(i);
                //Return a plan object
                result[i] = new plan(member);
    ...
    /**
     *
     * Obtain an array of plan objects based on a set of specified plan member names.
     * @param session  PstUserAbstractObject requesting the plan objects.
     * @param objectNames Object names of all plan objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a plan object.
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        ...
        plan [] newResult = new plan[newCount];
        for(int i=0; i<newCount; i++)
        {
            newResult[i] = (plan) result.get(i);
        }
     ...
     * @param dataObject The plan object to delete permanently.
     ...
     * @param dataObject The plan object to save.
     ...
     * @param dataObject The plan object to refresh.
     */
    public void refresh(PstAbstractObject dataObject)
    {
        ((plan)dataObject).refresh();

    }//End refresh


    /**
     * Obtain a List of plan objects based on on the user ID.
     *
     * @param user  PstUserAbstractObject requesting the plan objects.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An List of plan objects that is own by this user.
     *
     */
    public List getAllplan(PstUserAbstractObject user)
        throws PmpObjectNotFoundException, PmpInternalException
    {
    ...
    /**
     * Obtain a List of plan objects that belongs to the plan.
     *
     * @param projID - int value of a plan ID.
     * @param user - PstUserAbstractObject requesting the plan objects.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An List of plan objects that is own by this user.
     *
     */
    public List getAllplan(PstUserAbstractObject user, int projID)
        throws PmpObjectNotFoundException, PmpInternalException
    {
		List planList = new ArrayList();
