...
/////////////////////////////////////////////////////////////////////
//
//  File:   projTemplateManager.java
//  Author: FastPath CodeGen Engine
//  Date:   03.18.2004
//  Description:
//    This is a class that represent the container of projTemplate classes.
//
//  Modification:
...
/////////////////////////////////////////////////////////////////////
//
// projTemplateManager.java : For projTemplate object container manipulation
//
...
import oct.pst.PstUserAbstractObject;
 ...
 /**
  *
  * <b>General Description:</b>  projTemplateManager extends PstManager.  This class
  * manages all projTemplate objects such as creating, retrieving, saving, and
  * deleting projTemplate objects.
  *
  * projTemplateManager can only instantiated through the getInstance() method.
  *
  *
  * <b>Class Dependencies:</b>
  *   oct.codegen.projTemplate
...
public class projTemplateManager extends oct.pst.PstManager

{
    public static final String NAME = "projTemplate";     // The orgname of Object projTemplate
    public static final String CLASSNAME = "oct.codegen.projTemplate";     // The className of Object projTemplate

    private static projTemplateManager manager = null;


    /**
     * Construct an empty projTemplate object
     * @param userObj A PstUserAbstractObject.
     */
    private projTemplateManager(PstUserAbstractObject userObj)
    ...
    /**
     * Instantiates a projTemplateManager object.
     * @return A projTemplateManager.
     */
    public static projTemplateManager getInstance()
        throws PmpManagerCreationException, PmpInternalException
    {
        if(manager == null)
        {
            manager = new projTemplateManager(PstSystem.getInstance());
        }
        return manager;
    }//End getInstance
    ...
    /**
     * Create a new projTemplate object.
     * @param userObj The PstUserAbstractObject who is requesting to create a projTemplate.
     * @param type The type of projTemplate to create.<br>
     * @param projTemplateName The name of the projTemplate.
     *
     * @exception PmpObjectCreationException There was an error creating the projTemplate.
     * @exception PmpIllegalTypeException The specified compnaytype is invalid.
     * @return The data object that was created.  An explicit cast is required to convert to a projTemplate object.
     */
    public PstAbstractObject create(PstUserAbstractObject userObj, String projTemplateName)
        throws PmpIllegalTypeException, PmpObjectCreationException
    {
        return create(userObj.getSession(), projTemplateName);
    }//End create
     ...
     * @param projTemplateName The name of the projTemplate.
     * @exception PmpObjectCreationException There was an error creating the projTemplate.
     * @exception PmpIllegalTypeException The specified projTemplate type is invalid.
     * @return The data object that was created.  An explicit cast is required to convert to a projTemplate object.
     */
    PstAbstractObject create(OmsSession session, String projTemplateName)
        throws PmpIllegalTypeException, PmpObjectCreationException
    {
        projTemplate projTemplate = null;
        if(projTemplateName == null || projTemplateName.length() == 0)
        {
            throw new PmpObjectCreationException("The projTemplate name cannot be empty.");
        }

        try
        {

            projTemplate = new projTemplate(session,m_organization, projTemplateName);
            return projTemplate;
        }
        catch(PmpException pe)
        {
            ...
            throw new PmpObjectCreationException("Error creating projTemplate object:" + pe.toString());
        }
    }//End create
    ...
    {
		projTemplate newUser = null;
		try
		{
			newUser = new projTemplate(userObj, m_organization, memberName, password);
		}
		catch(PmpException e)
		{
			throw new PmpObjectCreationException("Cannot create new projTemplate");
		}
    	...
    	throws PmpObjectCreationException, PmpInternalException
    {
		...
		try
		{
			newUser = new projTemplate(userObj, m_organization);
		}
		catch(PmpException e)
		{
			throw new PmpObjectCreationException("Cannot create new projTemplate");
    ...
    /**
     *
     * Obtain a projTemplate object from database.
     * @param userObj  PstUserAbstractObject requesting a projTemplate object.
     * @param objectId Object id of the projTemplate object.
     ...
     * @return The data object with the specified id.  An explicit cast is required to convert to a projTemplate object.
     */
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        try
        {
            ...
            {
                throw new PmpObjectNotFoundException("Member not in projTemplate organization.");
            }

            //Return a projTemplate object
            return new projTemplate(member);
        }
    ...
    /**
     *
     * Obtain a projTemplate object from the database.
     * @param userObj  A PstUserAbstractObject.
     * @param objectName Object name of the projTemplate object.
     * @exception PmpObjectNotFoundException Could not find the specified object.
     * @exception PmpInternalException An internal error occurred.
     * @return The data object with the specified id.  An explicit cast is required to convert to a projTemplate object.
     */
    ...
    /**
     *
     * Obtain an array of projTemplate objects based on a set of specified object ids.
     * @param userObj  PstUserAbstractObject requesting the projTemplate objects.
     * @param objectIds Object ids in an int array of all projTemplate objects to retrieve.
     ...
     *  the data object to a projTemplate object.
     *   <b>NOTE:</b>  The arrays of projTemplate will be sorted by object ids,
     ...
     * Obtain an array of projTemplate objects based on a set of specified object ids.
     * @param userObj  PstUserAbstractObject requesting the projTemplate objects.
     * @param objectIds Object ids in an Integer array of all projTemplate objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a projTemplate object.
    ...
    /**
     *
     * Obtain a Company object based on a set of projTemplate ids.
     * Obtain an array of projTemplate objects based on a set of specified object ids.
     * @param session  PstUserAbstractObject requesting the projTemplate objects.
     * @param objectIds Object ids of all projTemplate objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a projTemplate object.
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        try
        {
            ...
            projTemplate [] result = new projTemplate[newCount];

            for(int i=0; i<newCount; i++)
            {
                OmsMember member = (OmsMember) memList.get(i);
                //Return a projTemplate object
                result[i] = new projTemplate(member);
    ...
    /**
     *
     * Obtain an array of projTemplate objects based on a set of specified projTemplate member names.
     * @param userObj  PstUserAbstractObject requesting the projTemplate objects.
     * @param objectNames Object names of all projTemplate objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a projTemplate object.
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        ...
        projTemplate [] newResult = new projTemplate[newCount];
        for(int i=0; i<newCount; i++)
        {
            newResult[i] = (projTemplate) result.get(i);
        }
     ...
     * @param dataObject The projTemplate object to delete permanently.
    ...
    {
        ((projTemplate)dataObject).delete();
     ...
     * @param dataObject The projTemplate object to save.
     ...
     * @param dataObject The projTemplate object to refresh.
     */
    public void refresh(PstAbstractObject dataObject)
    {
        ((projTemplate)dataObject).refresh();
    ...
    /**
     * Obtain a List of projTemplate objects that belongs to the projTemplate.
     *
     * @param userObj - PstUserAbstractObject requesting the projTemplate objects.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An List of projTemplate objects that is own by this user.
     *
     */
    public PstAbstractObject [] getAllprojTemplate(PstUserAbstractObject userObj)
        throws PmpObjectNotFoundException, PmpInternalException
    {
