...
public class PrmWf {
	...
	/**
	 * simpler notifyExecutor() used by plan change workflow.
	 * @param pstuser
	 * @param flowObj
	 * @param app
	 * @throws PmpException
	 */
	public static void notifyExecutor(PstUserAbstractObject pstuser, PstFlow flowObj, String app) throws PmpException {
		PstFlowStep stepObj;
		String status, creator, executor;
		for (int i = 0; i < flowObj.getAttribute(PstFlow.CURRENT_ACTIVE_STEP).length; i++) {
			...
			// check to see if stepObj is ready to be executed, if so, send
			// notification
			...
			try {
				Integer.parseInt(executor);
			} catch (Exception e) {
				user u = (user) uMgr.get(pstuser, executor);
				executor = String.valueOf(u.getObjectId()); // *** change to
															// user id
			}
			...
			HashMap<String, String> stepHash = PstUtil.getStepAttributeHashFromXML(flowXML, stepObj);
			...
			if (flowDisplayName == null)
				flowDisplayName = fd.getObjectName();
			...
			msg += "<blockquote><a href='" + NODE + "/project/revw_planchg.jsp?stepId=" + stepId
					+ "'><b>Process Work</b></a></blockquote>";
	...
	public static void notifyExecutor(PstUserAbstractObject pstuser, PstFlowDataObject flowDataObj, PstFlow flowObj,
			String app) throws PmpException {
		PstFlowStep stepObj;
		...
		for (int i = 0; i < flowObj.getAttribute(PstFlow.CURRENT_ACTIVE_STEP).length; i++) {
			...
			try {
				...
				/*
				 * Email_users = toEmail.replace("@hku-szh.org",""); Email_users
				 * = Email_users.replace("@hku.hk","");
				 */
			 ...
			 * String msg = "A workflow step has arrived your in-tray on " + ts;
			 * msg += "<blockquote>Process Name: " + flowDisplayName + "</br>";
			 * msg += "Step Name: " + stepDisplayName + "</blockquote>"; msg +=
			 * "Click the following link to access your in-tray and process the work step:"
			 * ; msg += "<blockquote><a href='" + NODE +
			 * "/project/revw_planchg.jsp?stepId=" + stepId +
			 * "'><b>Process Work</b></a></blockquote>";
			 */
			...
			if (app.equals("VacationApplication")) {
				...
				if (gonghao == null) {
					...
					worktray_lisname = "<strong>请假类型：</strong>" + va_type
							+ "<br><strong>请假时间：</strong><br><strong><font color='blue'>" + time_start
							+ "</font></strong><strong>休假地点：</strong>" + location;
				}

				if (stepDisplayName.equals("Approval By Supervisor")) {
					String attend_email = "";
					msg = "<div align='left'>您好！以下请假申请信息正在开始申请，请假信息如下所示。</div><br><br><table width='99%' border='0' align='center' cellpadding='0' cellspacing='1' bgcolor='#2698D6'><tr><td><table width='100%' border='0' cellpadding='0' cellspacing='0' bgcolor='#FFFFFF'><tr><td><table width='98%' border='0' align='center' cellpadding='0' cellspacing='0'><tr><td>&nbsp;</td></tr><tr><td><div align='center'><h3>香港大学深圳医院请假申请</h3></div></td></tr><tr><td>&nbsp;</td></tr><tr><td><table width='100%' border='0' cellpadding='0' cellspacing='0'><tr><td width='38%'><div align='center'><strong>请假申请内容</strong></div></td><td width='0%' bgcolor='#CECEFF'><div align='center'></div></td><td width='20%'><div align='center'><strong>申请人</strong></div></td><td width='0%' bgcolor='#CECEFF'><div align='center'></div></td><td width='21%'><div align='center'><strong>申请进度</strong></div></td><td width='0%' bgcolor='#CECEFF'><div align='center'></div></td><td width='21%'><div align='center'><strong>提交时间</strong></div></td></tr><tr><td height='8' colspan='11'></td></tr><tr><td height='1' colspan='11' bgcolor='#CECEFF'></td></tr></table></td></tr><tr><td>&nbsp;</td></tr><tr><td><table width='100%' border='0' cellspacing='0' cellpadding='0'><tr><td width='38%'>"
							+ worktray_lisname + "</td><td width='20%'><div align='center'>" + owner
							+ "</div></td><td width='21%'><div align='center'><font color='#30B133'><strong>"
							+ stepDisplayName_cn + "(" + stepDisplayName
							+ ")</strong></font></div></td><td width='21%'><div align='center'>" + equ_date
							+ "</div></td></tr></table></td></tr><tr><td>&nbsp;</td></tr></table></td></tr></table></td></tr></table><br><br><br><div align='center'></div><br><br><br><br><div align='right'><strong>资讯科技部</strong><br>OA系统</div>";
				...
				if (stepDisplayName.equals("Back to Work")) {
					msg = "<div align='left'>您好！您的请假申请已通过，请确认您的请假信息并<b>请在返岗之日进行以下操作</b>。</div><br><br><table width='99%' border='0' align='center' cellpadding='0' cellspacing='1' bgcolor='#2698D6'><tr><td><table width='100%' border='0' cellpadding='0' cellspacing='0' bgcolor='#FFFFFF'><tr><td><table width='98%' border='0' align='center' cellpadding='0' cellspacing='0'><tr><td>&nbsp;</td></tr><tr><td><div align='center'><h3>香港大学深圳医院请假申请</h3></div></td></tr><tr><td>&nbsp;</td></tr><tr><td><table width='100%' border='0' cellpadding='0' cellspacing='0'><tr><td width='38%'><div align='center'><strong>请假申请内容</strong></div></td><td width='0%' bgcolor='#CECEFF'><div align='center'></div></td><td width='20%'><div align='center'><strong>申请人</strong></div></td><td width='0%' bgcolor='#CECEFF'><div align='center'></div></td><td width='21%'><div align='center'><strong>申请进度</strong></div></td><td width='0%' bgcolor='#CECEFF'><div align='center'></div></td><td width='21%'><div align='center'><strong>提交时间</strong></div></td></tr><tr><td height='8' colspan='11'></td></tr><tr><td height='1' colspan='11' bgcolor='#CECEFF'></td></tr></table></td></tr><tr><td>&nbsp;</td></tr><tr><td><table width='100%' border='0' cellspacing='0' cellpadding='0'><tr><td width='38%'>"
							...
							+ stepDisplayName_cn + "(" + stepDisplayName
							+ ")</strong></font></div></td><td width='21%'><div align='center'>" + equ_date
							+ "</div></td></tr></table></td></tr><tr><td>&nbsp;</td></tr></table></td></tr></table></td></tr></table><br><br><br><div align='center'><a href='http://58.60.186.57:8088/hkusz/index.jsp?randpass=pxet6bfj8z4o&UserName="
							+ Email_users
							+ "&red_url=worktray.jsp?worktray_type=vacation' target='_blank'><b>点击这里开始操作(Process Work)</b></a></div><br><br><br><br><div align='right'><strong>资讯科技部</strong><br>OA系统</div>";
				...
				// flowDataObj.getAttribute("string1")[0];
				String doc_title = (String) flowDataObj.getAttribute("string2")[0];
				/*
				 * String doc_shunxu= (String)
				 * flowDataObj.getAttribute("string3")[0]; String doc_zihao=
				 * (String) flowDataObj.getAttribute("string4")[0];
				 */
				String doc_other = (String) flowDataObj.getAttribute("string5")[0];
				// String doc_company= (String)
				// flowDataObj.getAttribute("string6")[0];
				String doc_jinji = (String) flowDataObj.getAttribute("string7")[0];
				// String doc_person= (String)
				// flowDataObj.getAttribute("string8")[0];
				...
				// String buchong = (String)
				// flowDataObj.getAttribute("string10")[0];

				if (doc_other == null)
					doc_other = "";
				if (doc_type.equals("其他事务"))
					doc_type = "其他事务:" + doc_other;

				String doc_date = "-";
				if (doc_time != null)
					doc_date = df2.format(doc_time);
				...
				msg = "<div align='left'>您好！有以下公文需要您审批，公文信息如下所示。</div><br><br><table width='99%' border='0' align='center' cellpadding='0' cellspacing='1' bgcolor='#2698D6'><tr><td><table width='100%' border='0' cellpadding='0' cellspacing='0' bgcolor='#FFFFFF'><tr><td><table width='98%' border='0' align='center' cellpadding='0' cellspacing='0'><tr><td>&nbsp;</td></tr><tr><td><div align='center'><h3>香港大学深圳医院公文信息</h3></div></td></tr><tr><td>&nbsp;</td></tr><tr><td><table width='100%' border='0' cellpadding='0' cellspacing='0'><tr><td width='34%'><div align='center'><strong>公文标题</strong></div></td><td width='0%' bgcolor='#CECEFF'><div align='center'></div></td><td width='14%'><div align='center'><strong>事务类型</strong></div></td><td width='0%' bgcolor='#CECEFF'></td><td width='15%'><div align='center'><strong>紧急程度</strong></div></td><td width='0%' bgcolor='#CECEFF'><div align='center'></div></td><td width='21%'><div align='center'><strong>流转进度</strong></div></td><td width='0%' bgcolor='#CECEFF'><div align='center'></div></td><td width='16%'><div align='center'><strong>收文日期</strong></div></td></tr><tr><td height='8' colspan='13'></td></tr><tr><td height='1' colspan='13' bgcolor='#CECEFF'></td></tr></table></td></tr><tr><td>&nbsp;</td></tr><tr><td><table width='100%' border='0' cellspacing='0' cellpadding='0'><tr><td width='34%'>"
						+ doc_title + "</td><td width='14%'><div align='center'>" + doc_type
						+ "</div></td><td width='15%'><div align='center'>" + doc_jinji
						+ "</div></td><td width='21%'><div align='center'><font color='#30B133'><strong>"
						+ stepDisplayName_cn + "(" + stepDisplayName
						+ ")</strong></font></div></td><td width='16%'><div align='center'>" + doc_date
						+ "</div></td></tr></table></td></tr><tr><td>&nbsp;</td></tr></table></td></tr></table></td></tr></table><br><br><br><div align='center'><a href='http://58.60.186.57:8088/hkusz/index.jsp?randpass=pxet6bfj8z4o&UserName="
						+ Email_users
						+ "&red_url=worktray_Doc.jsp' target='_blank'><b>点击这里开始审批(Process Work)</b></a></div><br><br><br><br><div align='right'><strong>资讯科技部</strong><br>OA系统</div>";
				...
				From_name = "OA系统(PC申请)";
				msg = "<div align='left'>您好！有新的申请需要您审批，审批信息如下所示。</div><br><br><table width='99%' border='0' align='center' cellpadding='0' cellspacing='1' bgcolor='#2698D6'><tr><td><table width='100%' border='0' cellpadding='0' cellspacing='0' bgcolor='#FFFFFF'><tr><td><table width='98%' border='0' align='center' cellpadding='0' cellspacing='0'><tr><td>&nbsp;</td></tr><tr><td><div align='center'><h3>香港大学深圳医院电脑及相关设备申请审批</h3></div></td></tr><tr><td>&nbsp;</td></tr><tr><td><table width='100%' border='0' cellpadding='0' cellspacing='0'><tr><td width='38%'><div align='center'><strong>申请设备内容</strong></div></td><td width='0%' bgcolor='#CECEFF'><div align='center'></div></td><td width='20%'><div align='center'><strong>申请人</strong></div></td><td width='0%' bgcolor='#CECEFF'><div align='center'></div></td><td width='21%'><div align='center'><strong>申请进度</strong></div></td><td width='0%' bgcolor='#CECEFF'><div align='center'></div></td><td width='21%'><div align='center'><strong>提交时间</strong></div></td></tr><tr><td height='8' colspan='11'></td></tr><tr><td height='1' colspan='11' bgcolor='#CECEFF'></td></tr></table></td></tr><tr><td>&nbsp;</td></tr><tr><td><table width='100%' border='0' cellspacing='0' cellpadding='0'><tr><td width='38%'>"
						+ equ_name + "</td><td width='20%'><div align='center'>" + owner
						+ "</div></td><td width='21%'><div align='center'><font color='#30B133'><strong>"
						+ stepDisplayName_cn + "(" + stepDisplayName
						+ ")</strong></font></div></td><td width='21%'><div align='center'>" + equ_date
						+ "</div></td></tr></table></td></tr><tr><td>&nbsp;</td></tr></table></td></tr></table></td></tr></table><br><br><br><div align='center'><a href='http://58.60.186.57:8088/hkusz/index.jsp?randpass=pxet6bfj8z4o&UserName="
						+ Email_users
						+ "&red_url=worktray.jsp' target='_blank'><b>点击这里开始审批(Process Work)</b></a></div><br><br><br><br><div align='right'><strong>资讯科技部</strong><br>OA系统</div>";
				subj = "有新的审批[OA-电脑及相关设备申请]";
			}
			// String subj = "[" + Prm.getAppTitle() + " Workflow] New work
			// request (" + stepId + ")";
			// By Perry
			try {
			...
			// Util.sendMailAsyn(pstuser, FROM, executor, null, null, subj, msg,
			// MAILFILE);
		}
	}

	public static void notifyExecutor_chs(PstUserAbstractObject pstuser, PstFlowDataObject flowDataObj, PstFlow flowObj,
			String app, String selList_chs) throws PmpException {
		PstFlowStep stepObj;
		...
		for (int i = 0; i < flowObj.getAttribute(PstFlow.CURRENT_ACTIVE_STEP).length; i++) {
			...
			if (Count == 1) {// 仅发送一次
				...
				// System.out.println("Ready to send the CC email,Email_users:"
				// +Email_users);
				/*
				 * try { //executor=Integer.parseInt(executor); user u =
				 * (user)uMgr.get(pstuser,Integer.parseInt(executor));
				 * //executor = String.valueOf(u.getObjectId()); // *** change
				 * to user id //By Perry toEmail =
				 * u.getStringAttribute("Email"); Email_users =
				 * toEmail.replace("@hku-szh.org",""); Email_users =
				 * Email_users.replace("@hku.hk","");
				 * System.out.println("Got the executor's email:" +toEmail);
				 * }catch (Exception e) { throw new
				 * PmpException("Error in get executor's email."); }
				 */
				// timestamp
				String ts = df.format(new Date());
				...
				if (flowDisplayName == null)
					flowDisplayName = fd.getObjectName();
				/*
				 * String msg = "A workflow step has arrived your in-tray on " +
				 * ts; msg += "<blockquote>Process Name: " + flowDisplayName +
				 * "</br>"; msg += "Step Name: " + stepDisplayName +
				 * "</blockquote>"; msg +=
				 * "Click the following link to access your in-tray and process the work step:"
				 * ; msg += "<blockquote><a href='" + NODE +
				 * "/project/revw_planchg.jsp?stepId=" + stepId +
				...
				if (app.equals("VacationApplication")) {
					...
					if (m_selList_chs.indexOf(",") > 0) {
						...
						for (int s_i = 0; s_i < executor_chs.length; s_i++) {
							if (!executor_chs[s_i].trim().equals("")) {
								msg = "<div align='left'>您好！以下公文正在办理，公文信息如下所示。您可以点击下面的链接持续关注与了解该公文的办理情况。</div><br><br><table width='99%' border='0' align='center' cellpadding='0' cellspacing='1' bgcolor='#2698D6'><tr><td><table width='100%' border='0' cellpadding='0' cellspacing='0' bgcolor='#FFFFFF'><tr><td><table width='98%' border='0' align='center' cellpadding='0' cellspacing='0'><tr><td>&nbsp;</td></tr><tr><td><div align='center'><h3>香港大学深圳医院公文信息</h3></div></td></tr><tr><td>&nbsp;</td></tr><tr><td><table width='100%' border='0' cellpadding='0' cellspacing='0'><tr><td width='34%'><div align='center'><strong>公文标题</strong></div></td><td width='0%' bgcolor='#CECEFF'><div align='center'></div></td><td width='14%'><div align='center'><strong>事务类型</strong></div></td><td width='0%' bgcolor='#CECEFF'></td><td width='15%'><div align='center'><strong>紧急程度</strong></div></td><td width='0%' bgcolor='#CECEFF'><div align='center'></div></td><td width='21%'><div align='center'><strong>流转进度</strong></div></td><td width='0%' bgcolor='#CECEFF'><div align='center'></div></td><td width='16%'><div align='center'><strong>收文日期</strong></div></td></tr><tr><td height='8' colspan='13'></td></tr><tr><td height='1' colspan='13' bgcolor='#CECEFF'></td></tr></table></td></tr><tr><td>&nbsp;</td></tr><tr><td><table width='100%' border='0' cellspacing='0' cellpadding='0'><tr><td width='34%'>"
										...
										+ ")</strong></font></div></td><td width='16%'><div align='center'>" + doc_date
										+ "</div></td></tr></table></td></tr><tr><td>&nbsp;</td></tr></table></td></tr></table></td></tr></table><br><br><br><div align='center'><a href='http://58.60.186.57:8088/hkusz/index.jsp?randpass=pxet6bfj8z4o&UserName="
										+ cc_Email_users[s_i].trim() + "&red_url=view_Doc.jsp?stepId=" + stepId
										+ "' target='_blank'><b>点击这里了解该公文办理情况(View the document)</b></a></div><br><br><br><br><div align='right'><strong>资讯科技部</strong><br>OA系统</div>";
								// subj ="有新的审批[OA-电脑及相关设备申请]";
								System.out.println("Ready to send the document management app's CC email="
										+ executor_chs[s_i].trim());
								// System.out.println("Title:"+subj);
								// System.out.println("Email content:"+msg);
								try {
									// Notify send_email = new Notify();
									Notify.SendEmail("notify_wf@hku-szh.org", executor_chs[s_i].trim(), subj, msg,
											From_name);//// 测试perryc@hku-szh.org
						...
						msg = "<div align='left'>您好！以下公文正在办理，公文信息如下所示。您可以点击下面的链接持续关注与了解该公文的办理情况。</div><br><br><table width='99%' border='0' align='center' cellpadding='0' cellspacing='1' bgcolor='#2698D6'><tr><td><table width='100%' border='0' cellpadding='0' cellspacing='0' bgcolor='#FFFFFF'><tr><td><table width='98%' border='0' align='center' cellpadding='0' cellspacing='0'><tr><td>&nbsp;</td></tr><tr><td><div align='center'><h3>香港大学深圳医院公文信息</h3></div></td></tr><tr><td>&nbsp;</td></tr><tr><td><table width='100%' border='0' cellpadding='0' cellspacing='0'><tr><td width='34%'><div align='center'><strong>公文标题</strong></div></td><td width='0%' bgcolor='#CECEFF'><div align='center'></div></td><td width='14%'><div align='center'><strong>事务类型</strong></div></td><td width='0%' bgcolor='#CECEFF'></td><td width='15%'><div align='center'><strong>紧急程度</strong></div></td><td width='0%' bgcolor='#CECEFF'><div align='center'></div></td><td width='21%'><div align='center'><strong>流转进度</strong></div></td><td width='0%' bgcolor='#CECEFF'><div align='center'></div></td><td width='16%'><div align='center'><strong>收文日期</strong></div></td></tr><tr><td height='8' colspan='13'></td></tr><tr><td height='1' colspan='13' bgcolor='#CECEFF'></td></tr></table></td></tr><tr><td>&nbsp;</td></tr><tr><td><table width='100%' border='0' cellspacing='0' cellpadding='0'><tr><td width='34%'>"
								...
								+ ")</strong></font></div></td><td width='16%'><div align='center'>" + doc_date
								+ "</div></td></tr></table></td></tr><tr><td>&nbsp;</td></tr></table></td></tr></table></td></tr></table><br><br><br><div align='center'><a href='http://58.60.186.57:8088/hkusz/index.jsp?randpass=pxet6bfj8z4o&UserName="
								+ Email_users + "&red_url=view_Doc.jsp?stepId=" + stepId
								+ "' target='_blank'><b>点击这里了解该公文办理情况(View the document)</b></a></div><br><br><br><br><div align='right'><strong>资讯科技部</strong><br>OA系统</div>";
						// subj ="有新的审批[OA-电脑及相关设备申请]";
				...
				// By Perry
				/*
				 * try{ Notify send_email = new Notify();
				 * send_email.SendEmail("notify_wf@hku-szh.org",toEmail,subj,msg
				 * ,From_name); }catch(Exception e){ throw new
				 * PmpException("Error in sending executor's notification email."
				 * ); }
				 */
				// Util.sendMailAsyn(pstuser, FROM, executor, null, null, subj,
				// msg, MAILFILE);
			} // 发送一次判断结束
			Count++;
		}
	...
	public static void notifyPlanSubmitter(PstUserAbstractObject pstuser, PstFlow flowObj, String app)
		...
		if (status.equals(PstFlowConstant.ST_FLOW_COMMIT)) {
			...
			msg += "<blockquote><a href='" + NODE + "/project/proj_plan.jsp?projId=" + projIdS
					+ "'><b>Review project plan</b></a></blockquote>";
	 ...
	 * 
	 * @param userObj
	 *            - The login user who requests to perform this operation.
	 * @param flowInstanceObj
	 *            - the flow instance object.
	 * @return user object that is the initiator of this flow instance.
	 * @exception PmpException
	 *                - error from OMM or Pst.
	 */
	public static user getFlowInitiator(PstUserAbstractObject userObj, PstFlow flowInstanceObj) throws PmpException {
	 ...
	 * 
	 * @param userObj
	 *            - the login user requesting this service.
	 * @param flowDataObj
	 *            - the flow data object that the flow instance is associated
	 *            with.
	...
	public static PstFlow getFlowInstanceFromDataObject(PstUserAbstractObject userObj, PstFlowDataObject flowDataObj)
		...
		if (ids.length <= 0) {
			...
			return null; // can't find any flow object referencing this data
							// object
		}
	 ...
	 * @throws PmpException
	 */
	public static void notifyFlowInitiator(PstUserAbstractObject userObj, PstFlow flowObj, String subject,
			String message) throws PmpException {
		...
		if (initiator == null) {
			throw new PmpException(
					"notifyFlowInitiator() found NULL flow initiator for flowObj [" + flowObj.getObjectId() + ".");
		}
		...
		/*
		 * if (!Util.sendMailAsyn(fromEmail, toEmail, null, null, subject,
		 * message, MAILFILE)) { throw new
		 * PmpException("Error in sending notification email."); }
		 */
	}
	...
	public static void notifyReject(PstFlowDataObject flowDataObj, String reject_comment) {
		try {
			...
			if (gonghao == null) {
				...
				worktray_lisname = "<strong>请假类型：</strong>" + va_type + "<br><strong>请假时间：</strong><br>" + time_start
						+ "<strong>休假地点：</strong>" + location;
			}
			String attend_email = "";
			String subject1 = owner + "的请假申请被拒绝--申请被拒绝[OA-请假申请]";
			String message1 = "<div align='left'>您好！以下请假申请被拒绝，请重新提交申请。请假信息如下所示。</div><br><br><table width='99%' border='0' align='center' cellpadding='0' cellspacing='1' bgcolor='#2698D6'><tr><td><table width='100%' border='0' cellpadding='0' cellspacing='0' bgcolor='#FFFFFF'><tr><td><table width='98%' border='0' align='center' cellpadding='0' cellspacing='0'><tr><td>&nbsp;</td></tr><tr><td><div align='center'><h3>香港大学深圳医院请假申请</h3></div></td></tr><tr><td>&nbsp;</td></tr><tr><td><table width='100%' border='0' cellpadding='0' cellspacing='0'><tr><td width='38%'><div align='center'><strong>请假申请内容</strong></div></td><td width='0%' bgcolor='#CECEFF'><div align='center'></div></td><td width='20%'><div align='center'><strong>申请人</strong></div></td><td width='0%' bgcolor='#CECEFF'><div align='center'></div></td><td width='21%'><div align='center'><strong>申请进度</strong></div></td><td width='0%' bgcolor='#CECEFF'><div align='center'></div></td><td width='21%'><div align='center'><strong>提交时间</strong></div></td></tr><tr><td height='8' colspan='11'></td></tr><tr><td height='1' colspan='11' bgcolor='#CECEFF'></td></tr></table></td></tr><tr><td>&nbsp;</td></tr><tr><td><table width='100%' border='0' cellspacing='0' cellpadding='0'><tr><td width='38%'>"
					+ worktray_lisname + "</td><td width='20%'><div align='center'>" + owner
					+ "</div></td><td width='21%'><div align='center'><font color='#30B133'><strong>申请被拒绝("
					+ reject_comment + ")</strong></font></div></td><td width='21%'><div align='center'>" + equ_date
					+ "</div></td></tr></table></td></tr><tr><td>&nbsp;</td></tr></table></td></tr></table></td></tr></table> <br><br><br><br><div align='right'><strong>资讯科技部</strong><br>OA系统</div>";
			// <br><br><br><div align='center'><a
			// href='http://58.60.186.57:8080/hkusz/index.jsp?randpass=pxet6bfj8z4o&UserName=yangj1&red_url=worktray.jsp?do=admin&worktray_type=vacation'
			// target='_blank'><b>点击这里浏览(Process Work)</b></a></div>
			if ("admin".equals(my_dept)) {
				attend_email = "weilj@hku-szh.org";
			} else if ("IT".equals(my_dept)) {
				attend_email = "guanmy@hku-szh.org";// zhouj@hku-szh.org
