...
/////////////////////////////////////////////////////////////////////
//
// day.java : implementation of the day class
//
...
/**
*
* <b>General Description:</b>  day extends PmpAbstractObject.  This class
* encapulates the data of a member from the "day" organization.
*
* The day class provides a facility to modify data of an existing day object.
*
*
*
* <b>Class Dependencies:</b>
*   oct.custom.dayManager
*   oct.pmp.PmpUser
...
public class day extends PstAbstractObject

{
	final public static String TYPE_HOLIDAY		= "Holiday";
	final public static String TYPE_SPECIAL		= "SpecialDay";

	final public static String RECUR_ANNUAL		= "Annual";
	
	final public static String NOTIFY_YES		= "Yes";
	final public static String NOTIFY_NO		= "No";
	
	final public static int SCOPE_PERSONAL		= 0;
	final public static int SCOPE_ALL			= 1;			// only Admin can set this

	// status of the day:
	// StartDate captures the beginning of this day to be effective
	// ExpireDate captures when the user delete the day
	// the object should stay in the DB for x years depending on policy of the site.

    //Private attributes


    static dayManager manager;

    /**
     * Constructor for instantiating a new day.
     * @param member An OmsMember representing a day.
     */
    public day(OmsMember member)
    {
        super(member);
        try
        {
        ...
        {
            //throw new PmpInternalException("Error getting dayManager instance.");
        }
    }//End Constructor
     ...
     */
	day(PstUserAbstractObject userObj, OmsOrganization org, String memberName, String password)
		throws PmpException
	{
    ...
    /**
     * Constructor for creating a day.  Used by dayManager.
     * @param userObj A PmpUser.
     * @param org The OmsOrganization for the day.
     */
    day(PstUserAbstractObject userObj, OmsOrganization org)
    ...
    /**
     * Constructor for creating a day.
     * @param session An OmsSession.
     * @param org The OmsOrganization for the day.
     */
    day(OmsSession session, OmsOrganization org)
        throws PmpObjectCreationException, PmpInternalException
    {
        super(session, org, "");
         try
    ...
    /**
     * Constructor for creating a day using a member name.
     * @param userObj A PmpUser.
     * @param org The OmsOrganization for the day.
     * @param dayMemName The member name for the created day.
     */
    day(PstUserAbstractObject userObj, OmsOrganization org, String dayMemName)
        throws PmpObjectCreationException, PmpInternalException
    {
        super(userObj, org, dayMemName, null);
        try
        {
          manager = dayManager.getInstance();
        }
     ...
     * @param session An OmsSession.
     * @param org The OmsOrganization for the day.
     * @param companyMemberName The member name for the created day.
     */
    day(OmsSession session, OmsOrganization org, String dayMemName)
        throws PmpObjectCreationException, PmpInternalException
    {
        super(session, org, dayMemName, null);
        try
        {
           manager = dayManager.getInstance();
        }
