...
//  Date:   06.16.2006
//  Description:
//    This is a class that represent the container of quest classes.
//
//  Modification:
...
/////////////////////////////////////////////////////////////////////
//
// questManager.java : For quest object container manipulation
//
...
import oct.pst.PstUserAbstractObject;
 ...
 /**
  *
  * <b>General Description:</b>  questManager extends PstManager.  This class
  * manages all quest objects such as creating, retrieving, saving, and
  * deleting quest objects.
  *
  * questManager can only instantiated through the getInstance() method.
  *
  *
...
public class questManager extends oct.pst.PstManager

{
    public static final String NAME = "quest";     // The orgname of Object quest
    public static final String CLASSNAME = "oct.codegen.quest";     // The className of Object quest

    private static questManager manager = null;


    /**
     * Construct an empty quest object
     * @param userObj A PstUserAbstractObject.
     */
    private questManager(PstUserAbstractObject userObj)
    ...
    /**
     * Instantiates a questManager object.
     * @return A questManager.
     */
        ...
        throws PmpManagerCreationException, PmpInternalException
    {
        if(manager == null)
        {
            manager = new questManager(PstSystem.getInstance());
        }
        return manager;
    }//End getInstance
     ...
     * @param userObj The PstUserAbstractObject who is requesting to create a quest.
     * @param type The type of quest to create.<br>
     * @param questName The name of the quest.
     *
     * @exception PmpObjectCreationException There was an error creating the quest.
     * @exception PmpIllegalTypeException The specified compnaytype is invalid.
     * @return The data object that was created.  An explicit cast is required to convert to a quest object.
     */
    public PstAbstractObject create(PstUserAbstractObject userObj, String questName)
        throws PmpIllegalTypeException, PmpObjectCreationException
    {
        return create(userObj.getSession(), questName);
    }//End create
     ...
     * @param questName The name of the quest.
     * @exception PmpObjectCreationException There was an error creating the quest.
     * @exception PmpIllegalTypeException The specified quest type is invalid.
     * @return The data object that was created.  An explicit cast is required to convert to a quest object.
     */
    PstAbstractObject create(OmsSession session, String questName)
        throws PmpIllegalTypeException, PmpObjectCreationException
    {
        quest quest = null;
        if(questName == null || questName.length() == 0)
        {
            throw new PmpObjectCreationException("The quest name cannot be empty.");
        }

        try
        {

            quest = new quest(session,m_organization, questName);
            return quest;
        }
        catch(PmpException pe)
        {
            ...
            throw new PmpObjectCreationException("Error creating quest object:" + pe.toString());
        }
    }//End create
    	...
    	throws PmpObjectCreationException, PmpInternalException
    {
		...
		try
		{
			newUser = new quest(userObj, m_organization, memberName, password);
		}
		catch(PmpException e)
		{
			throw new PmpObjectCreationException("Cannot create new quest");
		}
    	...
    	throws PmpObjectCreationException, PmpInternalException
    {
		...
		try
		{
			newUser = new quest(userObj, m_organization);
		}
		catch(PmpException e)
		{
			throw new PmpObjectCreationException("Cannot create new quest");
    ...
    /**
     *
     * Obtain a quest object from database.
     * @param userObj  PstUserAbstractObject requesting a quest object.
     * @param objectId Object id of the quest object.
     ...
     * @return The data object with the specified id.  An explicit cast is required to convert to a quest object.
     */
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        try
        {
            ...
            {
                throw new PmpObjectNotFoundException("Member not in quest organization.");
            }

            //Return a quest object
            return new quest(member);
        }
    ...
    /**
     *
     * Obtain a quest object from the database.
     * @param userObj  A PstUserAbstractObject.
     * @param objectName Object name of the quest object.
     * @exception PmpObjectNotFoundException Could not find the specified object.
     * @exception PmpInternalException An internal error occurred.
     * @return The data object with the specified id.  An explicit cast is required to convert to a quest object.
     */
    ...
    /**
     *
     * Obtain an array of quest objects based on a set of specified object ids.
     * @param userObj  PstUserAbstractObject requesting the quest objects.
     * @param objectIds Object ids in an int array of all quest objects to retrieve.
     ...
     *  the data object to a quest object.
     *   <b>NOTE:</b>  The arrays of quest will be sorted by object ids,
     ...
     * Obtain an array of quest objects based on a set of specified object ids.
     * @param userObj  PstUserAbstractObject requesting the quest objects.
     * @param objectIds Object ids in an Integer array of all quest objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a quest object.
    ...
    /**
     *
     * Obtain a Company object based on a set of quest ids.
     * Obtain an array of quest objects based on a set of specified object ids.
     * @param session  PstUserAbstractObject requesting the quest objects.
     * @param objectIds Object ids of all quest objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a quest object.
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        try
        {
            ...
            quest [] result = new quest[newCount];

            for(int i=0; i<newCount; i++)
            {
                OmsMember member = (OmsMember) memList.get(i);
                //Return a quest object
                result[i] = new quest(member);
    ...
    /**
     *
     * Obtain an array of quest objects based on a set of specified quest member names.
     * @param userObj  PstUserAbstractObject requesting the quest objects.
     * @param objectNames Object names of all quest objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a quest object.
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        ...
        quest [] newResult = new quest[newCount];
        for(int i=0; i<newCount; i++)
        {
            newResult[i] = (quest) result.get(i);
        }
     ...
     * @param dataObject The quest object to delete permanently.
     ...
     * @param dataObject The quest object to save.
     ...
     * @param dataObject The quest object to refresh.
     */
    public void refresh(PstAbstractObject dataObject)
    {
        ((quest)dataObject).refresh();
    ...
    /**
     * Obtain a List of quest objects that belongs to the quest.
     *
     * @param userObj - PstUserAbstractObject requesting the quest objects.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An List of quest objects that is own by this user.
     *
     */
    public PstAbstractObject [] getAllquest(PstUserAbstractObject userObj)
        throws PmpObjectNotFoundException, PmpInternalException
    {
