...
//  Date:   06.16.2006
//  Description:
//    This is a class that represent the container of application classes.
//
//  Modification:
...
/////////////////////////////////////////////////////////////////////
//
// applicationManager.java : For application object container manipulation
//
...
import oct.pst.PstUserAbstractObject;
 ...
 /**
  *
  * <b>General Description:</b>  applicationManager extends PstManager.  This class
  * manages all application objects such as creating, retrieving, saving, and
  * deleting application objects.
  *
  * applicationManager can only instantiated through the getInstance() method.
  *
  *
  * <b>Class Dependencies:</b>
  *   oct.codegen.application
...
public class applicationManager extends oct.pst.PstManager

{
    public static final String NAME = "application";     // The orgname of Object application
    public static final String CLASSNAME = "oct.codegen.application";     // The className of Object application

    private static applicationManager manager = null;


    /**
     * Construct an empty application object
     * @param userObj A PstUserAbstractObject.
     */
    private applicationManager(PstUserAbstractObject userObj)
    ...
    /**
     * Instantiates a applicationManager object.
        ...
        throws PmpManagerCreationException, PmpInternalException
    {
        if(manager == null)
        {
            manager = new applicationManager(PstSystem.getInstance());
        }
        return manager;
    }//End getInstance
     ...
     * @param userObj The PstUserAbstractObject who is requesting to create a application.
     * @param type The type of application to create.<br>
     * @param applicationName The name of the application.
     *
     * @exception PmpObjectCreationException There was an error creating the application.
     * @exception PmpIllegalTypeException The specified compnaytype is invalid.
     * @return The data object that was created.  An explicit cast is required to convert to a application object.
     */
    public PstAbstractObject create(PstUserAbstractObject userObj, String applicationName)
        throws PmpIllegalTypeException, PmpObjectCreationException
    {
        return create(userObj.getSession(), applicationName);
    }//End create
     ...
     * @param applicationName The name of the application.
     * @exception PmpObjectCreationException There was an error creating the application.
     * @exception PmpIllegalTypeException The specified application type is invalid.
     * @return The data object that was created.  An explicit cast is required to convert to a application object.
     */
    PstAbstractObject create(OmsSession session, String applicationName)
        throws PmpIllegalTypeException, PmpObjectCreationException
    {
        application application = null;
        if(applicationName == null || applicationName.length() == 0)
        {
            throw new PmpObjectCreationException("The application name cannot be empty.");
        }

        try
        {

            application = new application(session,m_organization, applicationName);
            return application;
        }
        catch(PmpException pe)
        {
            throw new PmpObjectCreationException("Error creating application object:" + pe.toString());
        }
    }//End create
    ...
    {
		application newUser = null;
		try
		{
			newUser = new application(userObj, m_organization, memberName, password);
		}
		catch(PmpException e)
		{
			throw new PmpObjectCreationException("Cannot create new application");
		}
    	...
    	throws PmpObjectCreationException, PmpInternalException
    {
		...
		try
		{
			newUser = new application(userObj, m_organization);
		}
		catch(PmpException e)
		{
			throw new PmpObjectCreationException("Cannot create new application");
    ...
    /**
     *
     * Obtain a application object from database.
     * @param userObj  PstUserAbstractObject requesting a application object.
     * @param objectId Object id of the application object.
     ...
     * @return The data object with the specified id.  An explicit cast is required to convert to a application object.
     */
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        try
        {
            ...
            {
                throw new PmpObjectNotFoundException("Member not in application organization.");
            }

            //Return a application object
            return new application(member);
        }
    ...
    /**
     *
     * Obtain a application object from the database.
     * @param userObj  A PstUserAbstractObject.
     * @param objectName Object name of the application object.
     * @exception PmpObjectNotFoundException Could not find the specified object.
     * @exception PmpInternalException An internal error occurred.
     * @return The data object with the specified id.  An explicit cast is required to convert to a application object.
     */
    ...
    /**
     *
     * Obtain an array of application objects based on a set of specified object ids.
     * @param userObj  PstUserAbstractObject requesting the application objects.
     * @param objectIds Object ids in an int array of all application objects to retrieve.
     ...
     *  the data object to a application object.
     *   <b>NOTE:</b>  The arrays of application will be sorted by object ids,
     ...
     * Obtain an array of application objects based on a set of specified object ids.
     * @param userObj  PstUserAbstractObject requesting the application objects.
     * @param objectIds Object ids in an Integer array of all application objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a application object.
    ...
    /**
     *
     * Obtain a Company object based on a set of application ids.
     * Obtain an array of application objects based on a set of specified object ids.
     * @param session  PstUserAbstractObject requesting the application objects.
     * @param objectIds Object ids of all application objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a application object.
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        try
        {
            ...
            application [] result = new application[newCount];

            for(int i=0; i<newCount; i++)
            {
                OmsMember member = (OmsMember) memList.get(i);
                //Return a application object
                result[i] = new application(member);
    ...
    /**
     *
     * Obtain an array of application objects based on a set of specified application member names.
     * @param userObj  PstUserAbstractObject requesting the application objects.
     * @param objectNames Object names of all application objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a application object.
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        ...
        ArrayList <PstAbstractObject> result = new ArrayList<PstAbstractObject>();
        ...
        application [] newResult = new application[newCount];
        for(int i=0; i<newCount; i++)
        {
            newResult[i] = (application) result.get(i);
        }
     ...
     * @param dataObject The application object to delete permanently.
     ...
     * @param dataObject The application object to save.
     ...
     * @param dataObject The application object to refresh.
     */
    public void refresh(PstAbstractObject dataObject)
    {
        ((application)dataObject).refresh();
    ...
    /**
     * Obtain a List of application objects that belongs to the application.
     *
     * @param userObj - PstUserAbstractObject requesting the application objects.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An List of application objects that is own by this user.
     *
     */
    public PstAbstractObject [] getAllapplication(PstUserAbstractObject userObj)
        throws PmpObjectNotFoundException, PmpInternalException
    {
