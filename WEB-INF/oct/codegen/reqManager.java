...
/////////////////////////////////////////////////////////////////////
//
//  File:   reqManager.java
//  Author: FastPath CodeGen Engine
//  Date:   12.03.2008
//  Description:
//    This is a class that represent the container of req classes.
//
//  Modification:
...
/////////////////////////////////////////////////////////////////////
//
// reqManager.java : For req object container manipulation
//
...
import oct.pst.PstUserAbstractObject;
 ...
 /**
  *
  * <b>General Description:</b>  reqManager extends PstManager.  This class
  * manages all req objects such as creating, retrieving, saving, and
  * deleting req objects.
  *
  * reqManager can only instantiated through the getInstance() method.
  *
  *
...
public class reqManager extends oct.pst.PstManager

{
    public static final String NAME = "req";     // The orgname of Object req
    public static final String CLASSNAME = "oct.codegen.req";     // The className of Object req

    private static reqManager manager = null;


    /**
     * Construct an empty req object
     * @param userObj A PstUserAbstractObject.
     */
    private reqManager(PstUserAbstractObject userObj)
    ...
    /**
     * Instantiates a reqManager object.
     * @return A reqManager.
     */
        ...
        throws PmpManagerCreationException, PmpInternalException
    {
        if(manager == null)
        {
            manager = new reqManager(PstSystem.getInstance());
        }
        return manager;
    }//End getInstance
     ...
     * @param userObj The PstUserAbstractObject who is requesting to create a req.
     * @param type The type of req to create.<br>
     * @param requestName The name of the req.
     *
     * @exception PmpObjectCreationException There was an error creating the req.
     * @exception PmpIllegalTypeException The specified compnaytype is invalid.
     * @return The data object that was created.  An explicit cast is required to convert to a req object.
     */
    public PstAbstractObject create(PstUserAbstractObject userObj, String requestName)
        throws PmpIllegalTypeException, PmpObjectCreationException
    {
        return create(userObj.getSession(), requestName);
    }//End create
     ...
     * @param requestName The name of the req.
     * @exception PmpObjectCreationException There was an error creating the req.
     * @exception PmpIllegalTypeException The specified req type is invalid.
     * @return The data object that was created.  An explicit cast is required to convert to a req object.
     */
    PstAbstractObject create(OmsSession session, String requestName)
        throws PmpIllegalTypeException, PmpObjectCreationException
    {
        req obj = null;
        if(requestName == null || requestName.length() == 0)
        {
            throw new PmpObjectCreationException("The req name cannot be empty.");
        }

        try
        {

        	obj = new req(session,m_organization, requestName);
            return obj;
        }
        catch(PmpException pe)
        {
            ...
            throw new PmpObjectCreationException("Error creating req object:" + pe.toString());
        }
    }//End create
    	...
    	throws PmpObjectCreationException, PmpInternalException
    {
		...
		try
		{
			newUser = new req(userObj, m_organization, memberName, password);
		}
		catch(PmpException e)
		{
			throw new PmpObjectCreationException("Cannot create new req");
		}
    	...
    	throws PmpObjectCreationException, PmpInternalException
    {
		...
		try
		{
			newUser = new req(userObj, m_organization);
		}
		catch(PmpException e)
		{
			throw new PmpObjectCreationException("Cannot create new req");
    ...
    /**
     *
     * Obtain a req object from database.
     * @param userObj  PstUserAbstractObject requesting a req object.
     * @param objectId Object id of the req object.
     ...
     * @return The data object with the specified id.  An explicit cast is required to convert to a req object.
     */
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        try
        {
            ...
            {
                throw new PmpObjectNotFoundException("Member not in req organization.");
            }

            //Return a req object
            return new req(member);
        }
    ...
    /**
     *
     * Obtain a req object from the database.
     * @param userObj  A PstUserAbstractObject.
     * @param objectName Object name of the req object.
     * @exception PmpObjectNotFoundException Could not find the specified object.
     * @exception PmpInternalException An internal error occurred.
     * @return The data object with the specified id.  An explicit cast is required to convert to a req object.
     */
    ...
    /**
     *
     * Obtain an array of req objects based on a set of specified object ids.
     * @param userObj  PstUserAbstractObject requesting the req objects.
     * @param objectIds Object ids in an int array of all req objects to retrieve.
     ...
     *  the data object to a req object.
     *   <b>NOTE:</b>  The arrays of req will be sorted by object ids,
     ...
     * Obtain an array of req objects based on a set of specified object ids.
     * @param userObj  PstUserAbstractObject requesting the req objects.
     * @param objectIds Object ids in an Integer array of all req objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a req object.
    ...
    /**
     *
     * Obtain a Company object based on a set of req ids.
     * Obtain an array of req objects based on a set of specified object ids.
     * @param session  PstUserAbstractObject requesting the req objects.
     * @param objectIds Object ids of all req objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a req object.
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        try
        {
            ...
            req [] result = new req[newCount];

            for(int i=0; i<newCount; i++)
            {
                OmsMember member = (OmsMember) memList.get(i);
                //Return a req object
                result[i] = new req(member);
    ...
    /**
     *
     * Obtain an array of req objects based on a set of specified req member names.
     * @param userObj  PstUserAbstractObject requesting the req objects.
     * @param objectNames Object names of all req objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a req object.
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        ...
        req [] newResult = new req[newCount];
        for(int i=0; i<newCount; i++)
        {
            newResult[i] = (req) result.get(i);
        }
     ...
     * @param dataObject The req object to delete permanently.
     ...
     * @param dataObject The req object to save.
     ...
     * @param dataObject The req object to refresh.
     */
    public void refresh(PstAbstractObject dataObject)
    {
        ((req)dataObject).refresh();
    ...
    /**
     * Obtain a List of req objects that belongs to the req.
     *
     * @param userObj - PstUserAbstractObject requesting the req objects.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An List of req objects that is own by this user.
     *
     */
    public PstAbstractObject [] getAllrequest(PstUserAbstractObject userObj)
        throws PmpObjectNotFoundException, PmpInternalException
    {
