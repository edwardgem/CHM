...
/////////////////////////////////////////////////////////////////////
//
//  File:   projTemplate.java
//  Author: FastPath CodeGen Engine
//  Date:   03.18.2004
//  Description:
//		Implementation of projTemplate class
//  Modification:
...
/////////////////////////////////////////////////////////////////////
//
// projTemplate.java : implementation of the projTemplate class
//
...
/**
*
* <b>General Description:</b>  projTemplate extends PmpAbstractObject.  This class
* encapulates the data of a member from the "projTemplate" organization.
*
* The projTemplate class provides a facility to modify data of an existing projTemplate object.
*
*
*
* <b>Class Dependencies:</b>
*   oct.custom.projTemplateManager
*   oct.pmp.PmpUser
...
public class projTemplate extends PstAbstractObject

{
    ...
    static projTemplateManager manager;

    /**
     * Constructor for instantiating a new projTemplate.
     * @param member An OmsMember representing a projTemplate.
     */
    public projTemplate(OmsMember member)
    {
        super(member);
        try
        {
            manager = projTemplateManager.getInstance();
        }
        catch(PmpException pe)
        {
            //throw new PmpInternalException("Error getting projTemplateManager instance.");
        }
    }//End Constructor
     ...
     */
	projTemplate(PstUserAbstractObject userObj, OmsOrganization org, String memberName, String password)
		throws PmpException
	{
    ...
    /**
     * Constructor for creating a projTemplate.  Used by projTemplateManager.
     * @param userObj A PmpUser.
     * @param org The OmsOrganization for the projTemplate.
     */
    projTemplate(PstUserAbstractObject userObj, OmsOrganization org)
    ...
    /**
     * Constructor for creating a projTemplate.
     * @param session An OmsSession.
     * @param org The OmsOrganization for the projTemplate.
     */
    projTemplate(OmsSession session, OmsOrganization org)
        throws PmpObjectCreationException, PmpInternalException
    {
        super(session, org, "");
         try
    ...
    /**
     * Constructor for creating a projTemplate using a member name.
     * @param userObj A PmpUser.
     * @param org The OmsOrganization for the projTemplate.
     * @param projTemplateMemName The member name for the created projTemplate.
     */
    projTemplate(PstUserAbstractObject userObj, OmsOrganization org, String projTemplateMemName)
        throws PmpObjectCreationException, PmpInternalException
    {
        super(userObj, org, projTemplateMemName, null);
        try
        {
          manager = projTemplateManager.getInstance();
        }
     ...
     * @param session An OmsSession.
     * @param org The OmsOrganization for the projTemplate.
     * @param companyMemberName The member name for the created projTemplate.
     */
    projTemplate(OmsSession session, OmsOrganization org, String projTemplateMemName)
        throws PmpObjectCreationException, PmpInternalException
    {
        super(session, org, projTemplateMemName, null);
        try
        {
           manager = projTemplateManager.getInstance();
        }
