...
/////////////////////////////////////////////////////////////////////
//
//  File:   FlowDataManager.java
//  Author: FastPath CodeGen Engine
//  Date:   03.18.2004
//  Description:
//    This is a class that represent the container of FlowData classes.
//
//  Modification:
...
/////////////////////////////////////////////////////////////////////
//
// FlowDataManager.java : For FlowData object container manipulation
//
...
import oct.pst.PstUserAbstractObject;
 ...
 /**
  *
  * <b>General Description:</b>  FlowDataManager extends PstManager.  This class
  * manages all FlowData objects such as creating, retrieving, saving, and
  * deleting FlowData objects.
  *
  * FlowDataManager can only instantiated through the getInstance() method.
  *
  *
  * <b>Class Dependencies:</b>
  *   oct.codegen.FlowData
...
public class FlowDataManager extends oct.pst.PstManager

{
    public static final String NAME = "FlowData";     // The orgname of Object FlowData
    public static final String CLASSNAME = "oct.codegen.FlowData";     // The className of Object FlowData

    private static FlowDataManager manager = null;


    /**
     * Construct an empty FlowData object
     * @param userObj A PstUserAbstractObject.
     */
    private FlowDataManager(PstUserAbstractObject userObj)
    ...
    /**
     * Instantiates a FlowDataManager object.
     * @return A FlowDataManager.
     */
        ...
        throws PmpManagerCreationException, PmpInternalException
    {
        if(manager == null)
        {
            manager = new FlowDataManager(PstSystem.getInstance());
        }
        return manager;
    }//End getInstance
    ...
    /**
     * Create a new FlowData object.
     * @param userObj The PstUserAbstractObject who is requesting to create a FlowData.
     * @param type The type of FlowData to create.<br>
     * @param FlowDataName The name of the FlowData.
     *
     * @exception PmpObjectCreationException There was an error creating the FlowData.
     * @exception PmpIllegalTypeException The specified compnaytype is invalid.
     * @return The data object that was created.  An explicit cast is required to convert to a FlowData object.
     */
    public PstAbstractObject create(PstUserAbstractObject userObj, String FlowDataName)
        throws PmpIllegalTypeException, PmpObjectCreationException
    {
        return create(userObj.getSession(), FlowDataName);
    }//End create
     ...
     * @param FlowDataName The name of the FlowData.
     * @exception PmpObjectCreationException There was an error creating the FlowData.
     * @exception PmpIllegalTypeException The specified FlowData type is invalid.
     * @return The data object that was created.  An explicit cast is required to convert to a FlowData object.
     */
    PstAbstractObject create(OmsSession session, String FlowDataName)
        throws PmpIllegalTypeException, PmpObjectCreationException
    {
        FlowData FlowData = null;
        if(FlowDataName == null || FlowDataName.length() == 0)
        {
            throw new PmpObjectCreationException("The FlowData name cannot be empty.");
        }

        try
        {

            FlowData = new FlowData(session,m_organization, FlowDataName);
            return FlowData;
        }
        catch(PmpException pe)
        {
            ...
            throw new PmpObjectCreationException("Error creating FlowData object:" + pe.toString());
        }
    }//End create
    ...
    {
		FlowData newUser = null;
		try
		{
			newUser = new FlowData(userObj, m_organization, memberName, password);
		}
		catch(PmpException e)
		{
			throw new PmpObjectCreationException("Cannot create new FlowData");
		}
    	...
    	throws PmpObjectCreationException, PmpInternalException
    {
		...
		try
		{
			newUser = new FlowData(userObj, m_organization);
		}
		catch(PmpException e)
		{
			throw new PmpObjectCreationException("Cannot create new FlowData");
    ...
    /**
     *
     * Obtain a FlowData object from database.
     * @param userObj  PstUserAbstractObject requesting a FlowData object.
     * @param objectId Object id of the FlowData object.
     ...
     * @return The data object with the specified id.  An explicit cast is required to convert to a FlowData object.
     */
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        try
        {
            ...
            {
                throw new PmpObjectNotFoundException("Member not in FlowData organization.");
            }

            //Return a FlowData object
            return new FlowData(member);
        }
    ...
    /**
     *
     * Obtain a FlowData object from the database.
     * @param userObj  A PstUserAbstractObject.
     * @param objectName Object name of the FlowData object.
     * @exception PmpObjectNotFoundException Could not find the specified object.
     * @exception PmpInternalException An internal error occurred.
     * @return The data object with the specified id.  An explicit cast is required to convert to a FlowData object.
     */
    ...
    /**
     *
     * Obtain an array of FlowData objects based on a set of specified object ids.
     * @param userObj  PstUserAbstractObject requesting the FlowData objects.
     * @param objectIds Object ids in an int array of all FlowData objects to retrieve.
     ...
     *  the data object to a FlowData object.
     *   <b>NOTE:</b>  The arrays of FlowData will be sorted by object ids,
     ...
     * Obtain an array of FlowData objects based on a set of specified object ids.
     * @param userObj  PstUserAbstractObject requesting the FlowData objects.
     * @param objectIds Object ids in an Integer array of all FlowData objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a FlowData object.
    ...
    /**
     *
     * Obtain a Company object based on a set of FlowData ids.
     * Obtain an array of FlowData objects based on a set of specified object ids.
     * @param session  PstUserAbstractObject requesting the FlowData objects.
     * @param objectIds Object ids of all FlowData objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a FlowData object.
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        try
        {
            ...
            FlowData [] result = new FlowData[newCount];

            for(int i=0; i<newCount; i++)
            {
                OmsMember member = (OmsMember) memList.get(i);
                //Return a FlowData object
                result[i] = new FlowData(member);
    ...
    /**
     *
     * Obtain an array of FlowData objects based on a set of specified FlowData member names.
     * @param userObj  PstUserAbstractObject requesting the FlowData objects.
     * @param objectNames Object names of all FlowData objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a FlowData object.
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        ...
        FlowData [] newResult = new FlowData[newCount];
        for(int i=0; i<newCount; i++)
        {
            newResult[i] = (FlowData) result.get(i);
        }
     ...
     * @param dataObject The FlowData object to delete permanently.
     ...
     * @param dataObject The FlowData object to save.
     ...
     * @param dataObject The FlowData object to refresh.
     */
    public void refresh(PstAbstractObject dataObject)
    {
        ((FlowData)dataObject).refresh();
    ...
    /**
     * Obtain a List of FlowData objects that belongs to the FlowData.
     *
     * @param userObj - PstUserAbstractObject requesting the FlowData objects.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An List of FlowData objects that is own by this user.
     *
     */
    public PstAbstractObject [] getAllFlowData(PstUserAbstractObject userObj)
        throws PmpObjectNotFoundException, PmpInternalException
    {
