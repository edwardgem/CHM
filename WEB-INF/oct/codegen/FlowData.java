...
//  Date:   03.18.2004
//  Description:
//		Implementation of FlowData class
//  Modification:
...
/////////////////////////////////////////////////////////////////////
//
// FlowData.java : implementation of the FlowData class
//
...
/**
*
* <b>General Description:</b>  FlowData extends PmpAbstractObject.  This class
* encapulates the data of a member from the "FlowData" organization.
*
* The FlowData class provides a facility to modify data of an existing FlowData object.
*
*
*
* <b>Class Dependencies:</b>
*   oct.custom.FlowDataManager
*   oct.pmp.PmpUser
...
public class FlowData extends PstAbstractObject

{
    ...
    static FlowDataManager manager;

    /**
     * Constructor for instantiating a new FlowData.
     * @param member An OmsMember representing a FlowData.
     */
    public FlowData(OmsMember member)
    {
        super(member);
        try
        {
            manager = FlowDataManager.getInstance();
        }
        catch(PmpException pe)
        {
            //throw new PmpInternalException("Error getting FlowDataManager instance.");
        }
    }//End Constructor
     ...
     */
	FlowData(PstUserAbstractObject userObj, OmsOrganization org, String memberName, String password)
		throws PmpException
	{
    ...
    /**
     * Constructor for creating a FlowData.  Used by FlowDataManager.
     * @param userObj A PmpUser.
     * @param org The OmsOrganization for the FlowData.
     */
    FlowData(PstUserAbstractObject userObj, OmsOrganization org)
    ...
    /**
     * Constructor for creating a FlowData.
     * @param session An OmsSession.
     * @param org The OmsOrganization for the FlowData.
     */
    FlowData(OmsSession session, OmsOrganization org)
        throws PmpObjectCreationException, PmpInternalException
    {
        super(session, org, "");
         try
    ...
    /**
     * Constructor for creating a FlowData using a member name.
     * @param userObj A PmpUser.
     * @param org The OmsOrganization for the FlowData.
     * @param FlowDataMemName The member name for the created FlowData.
     */
    FlowData(PstUserAbstractObject userObj, OmsOrganization org, String FlowDataMemName)
        throws PmpObjectCreationException, PmpInternalException
    {
        super(userObj, org, FlowDataMemName, null);
        try
        {
          manager = FlowDataManager.getInstance();
        }
     ...
     * @param session An OmsSession.
     * @param org The OmsOrganization for the FlowData.
     * @param companyMemberName The member name for the created FlowData.
     */
    FlowData(OmsSession session, OmsOrganization org, String FlowDataMemName)
        throws PmpObjectCreationException, PmpInternalException
    {
        super(session, org, FlowDataMemName, null);
        try
        {
           manager = FlowDataManager.getInstance();
        }
