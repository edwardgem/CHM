...
//  Date:   03.18.2003
//  Description:
//		Implementation of plan class
//  Modification:
//		@03.18.2003aFCE File created by FastPath
//
/////////////////////////////////////////////////////////////////////
//
// plan.java : implementation of the plan class
//
...
/**
*
* <b>General Description:</b>  plan extends PmpAbstractObject.  This class
* encapulates the data of a member from the "plan" organization.
*
* The plan class provides a facility to modify data of an existing plan object.
*
*
*
* <b>Class Dependencies:</b>
*   oct.custom.planManager
*   oct.pmp.PmpUser
...
public class plan extends PstAbstractObject
{
	public static final String ST_LATEST = "Latest";
    ...
    /**
     * Constructor for instantiating a new plan.
     * @param member An OmsMember representing a plan.
     */
    public plan(OmsMember member)
    {
        super(member);
        try
        {
            manager = planManager.getInstance();
        }
        catch(PmpException pe)
        {
            //throw new PmpInternalException("Error getting planManager instance.");
        }
    }//End Constructor
     ...
     */
	plan(PstUserAbstractObject user, OmsOrganization org, String memberName, String password)
		throws PmpException
	{
    ...
    /**
     * Constructor for creating a plan.  Used by planManager.
     * @param user A PmpUser.
     * @param org The OmsOrganization for the plan.
     */
    plan(PstUserAbstractObject user, OmsOrganization org)
     ...
     * @param org The OmsOrganization for the plan.
     */
    plan(OmsSession session, OmsOrganization org)
        throws PmpObjectCreationException, PmpInternalException
    {
        super(session, org, "");
         try
    ...
    /**
     * Constructor for creating a plan using a member name.
     * @param user A PmpUser.
     * @param org The OmsOrganization for the plan.
     * @param planMemName The member name for the created plan.
     */
    plan(PstUserAbstractObject user, OmsOrganization org, String planMemName)
        throws PmpObjectCreationException, PmpInternalException
    {
        super(user, org, planMemName, null);
        try
        {
          manager = planManager.getInstance();
        }
     ...
     * @param session An OmsSession.
     * @param org The OmsOrganization for the plan.
     * @param companyMemberName The member name for the created plan.
     */
    plan(OmsSession session, OmsOrganization org, String planMemName)
        throws PmpObjectCreationException, PmpInternalException
    {
        super(session, org, planMemName, null);
        try
        {
           manager = planManager.getInstance();
        }
