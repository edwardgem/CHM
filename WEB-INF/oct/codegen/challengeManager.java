...
//  Date:   06.16.2006
//  Description:
//    This is a class that represent the container of challenge classes.
//
//  Modification:
...
/////////////////////////////////////////////////////////////////////
//
// challengeManager.java : For challenge object container manipulation
//
...
import oct.pst.PstUserAbstractObject;
 ...
 /**
  *
  * <b>General Description:</b>  challengeManager extends PstManager.  This class
  * manages all challenge objects such as creating, retrieving, saving, and
  * deleting challenge objects.
  *
  * challengeManager can only instantiated through the getInstance() method.
  *
  *
  * <b>Class Dependencies:</b>
  *   oct.codegen.challenge
...
public class challengeManager extends oct.pst.PstManager

{
    public static final String NAME = "challenge";     // The orgname of Object challenge
    public static final String CLASSNAME = "oct.codegen.challenge";     // The className of Object challenge

    private static challengeManager manager = null;


    /**
     * Construct an empty challenge object
     * @param userObj A PstUserAbstractObject.
     */
    private challengeManager(PstUserAbstractObject userObj)
    ...
    /**
     * Instantiates a challengeManager object.
     * @return A challengeManager.
     */
        ...
        throws PmpManagerCreationException, PmpInternalException
    {
        if(manager == null)
        {
            manager = new challengeManager(PstSystem.getInstance());
        }
        return manager;
    }//End getInstance
     ...
     * @param userObj The PstUserAbstractObject who is requesting to create a challenge.
     * @param type The type of challenge to create.<br>
     * @param challengeName The name of the challenge.
     *
     * @exception PmpObjectCreationException There was an error creating the challenge.
     * @exception PmpIllegalTypeException The specified compnaytype is invalid.
     * @return The data object that was created.  An explicit cast is required to convert to a challenge object.
     */
    public PstAbstractObject create(PstUserAbstractObject userObj, String challengeName)
        throws PmpIllegalTypeException, PmpObjectCreationException
    {
        return create(userObj.getSession(), challengeName);
    }//End create
     ...
     * @param challengeName The name of the challenge.
     * @exception PmpObjectCreationException There was an error creating the challenge.
     * @exception PmpIllegalTypeException The specified challenge type is invalid.
     * @return The data object that was created.  An explicit cast is required to convert to a challenge object.
     */
    PstAbstractObject create(OmsSession session, String challengeName)
        throws PmpIllegalTypeException, PmpObjectCreationException
    {
        challenge challenge = null;
        if(challengeName == null || challengeName.length() == 0)
        {
            throw new PmpObjectCreationException("The challenge name cannot be empty.");
        }

        try
        {

            challenge = new challenge(session,m_organization, challengeName);
            return challenge;
        }
        catch(PmpException pe)
        {
            throw new PmpObjectCreationException("Error creating challenge object:" + pe.toString());
        }
    }//End create
    ...
    {
		challenge newUser = null;
		try
		{
			newUser = new challenge(userObj, m_organization, memberName, password);
		}
		catch(PmpException e)
		{
			throw new PmpObjectCreationException("Cannot create new challenge");
		}
    	...
    	throws PmpObjectCreationException, PmpInternalException
    {
		...
		try
		{
			newUser = new challenge(userObj, m_organization);
		}
		catch(PmpException e)
		{
			throw new PmpObjectCreationException("Cannot create new challenge");
    ...
    /**
     *
     * Obtain a challenge object from database.
     * @param userObj  PstUserAbstractObject requesting a challenge object.
     * @param objectId Object id of the challenge object.
     ...
     * @return The data object with the specified id.  An explicit cast is required to convert to a challenge object.
     */
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        try
        {
            ...
            {
                throw new PmpObjectNotFoundException("Member not in challenge organization.");
            }

            //Return a challenge object
            return new challenge(member);
        }
    ...
    /**
     *
     * Obtain a challenge object from the database.
     * @param userObj  A PstUserAbstractObject.
     * @param objectName Object name of the challenge object.
     * @exception PmpObjectNotFoundException Could not find the specified object.
     * @exception PmpInternalException An internal error occurred.
     * @return The data object with the specified id.  An explicit cast is required to convert to a challenge object.
     */
    ...
    /**
     *
     * Obtain an array of challenge objects based on a set of specified object ids.
     * @param userObj  PstUserAbstractObject requesting the challenge objects.
     * @param objectIds Object ids in an int array of all challenge objects to retrieve.
     ...
     *  the data object to a challenge object.
     *   <b>NOTE:</b>  The arrays of challenge will be sorted by object ids,
     ...
     * Obtain an array of challenge objects based on a set of specified object ids.
     * @param userObj  PstUserAbstractObject requesting the challenge objects.
     * @param objectIds Object ids in an Integer array of all challenge objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a challenge object.
    ...
    /**
     *
     * Obtain a Company object based on a set of challenge ids.
     * Obtain an array of challenge objects based on a set of specified object ids.
     * @param session  PstUserAbstractObject requesting the challenge objects.
     * @param objectIds Object ids of all challenge objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a challenge object.
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        try
        {
            ...
            challenge [] result = new challenge[newCount];

            for(int i=0; i<newCount; i++)
            {
                OmsMember member = (OmsMember) memList.get(i);
                //Return a challenge object
                result[i] = new challenge(member);
    ...
    /**
     *
     * Obtain an array of challenge objects based on a set of specified challenge member names.
     * @param userObj  PstUserAbstractObject requesting the challenge objects.
     * @param objectNames Object names of all challenge objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a challenge object.
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        ...
        challenge [] newResult = new challenge[newCount];
        for(int i=0; i<newCount; i++)
        {
            newResult[i] = (challenge) result.get(i);
        }
     ...
     * @param dataObject The challenge object to delete permanently.
     ...
     * @param dataObject The challenge object to save.
     ...
     * @param dataObject The challenge object to refresh.
     */
    public void refresh(PstAbstractObject dataObject)
    {
        ((challenge)dataObject).refresh();
    ...
    /**
     * Obtain a List of challenge objects that belongs to the challenge.
     *
     * @param userObj - PstUserAbstractObject requesting the challenge objects.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An List of challenge objects that is own by this user.
     *
     */
    public PstAbstractObject [] getAllchallenge(PstUserAbstractObject userObj)
        throws PmpObjectNotFoundException, PmpInternalException
    {
