...
/////////////////////////////////////////////////////////////////////
//
// event.java : implementation of the event class
//
...
/**
*
* <b>General Description:</b>  event extends PmpAbstractObject.  This class
* encapulates the data of a member from the "event" organization.
*
* The event class provides a facility to modify data of an existing event object.
*
* <b>Class Dependencies:</b>
*   oct.custom.eventManager
*   oct.pmp.PmpUser
...
public class event extends PstAbstractObject

{
    ...
    /**
     * Constructor for instantiating a new event.
     * @param member An OmsMember representing a event.
     */
    public event(OmsMember member)
    {
        super(member);
        try
        {
        ...
        {
            //throw new PmpInternalException("Error getting eventManager instance.");
        }
    }//End Constructor
     ...
     */
	event(PstUserAbstractObject userObj, OmsOrganization org, String memberName, String password)
		throws PmpException
	{
    ...
    /**
     * Constructor for creating a event.  Used by eventManager.
     * @param userObj A PmpUser.
     * @param org The OmsOrganization for the event.
     */
    event(PstUserAbstractObject userObj, OmsOrganization org)
     ...
     * @param org The OmsOrganization for the event.
     */
    event(OmsSession session, OmsOrganization org)
        throws PmpObjectCreationException, PmpInternalException
    {
        super(session, org, "");
         try
    ...
    /**
     * Constructor for creating a event using a member name.
     * @param userObj A PmpUser.
     * @param org The OmsOrganization for the event.
     * @param eventMemName The member name for the created event.
     */
    event(PstUserAbstractObject userObj, OmsOrganization org, String eventMemName)
        throws PmpObjectCreationException, PmpInternalException
    {
        super(userObj, org, eventMemName, null);
        try
        {
          manager = eventManager.getInstance();
        }
     ...
     * @param session An OmsSession.
     * @param org The OmsOrganization for the event.
     * @param companyMemberName The member name for the created event.
     */
    event(OmsSession session, OmsOrganization org, String eventMemName)
        throws PmpObjectCreationException, PmpInternalException
    {
        super(session, org, eventMemName, null);
        try
        {
           manager = eventManager.getInstance();
        }
