...
//  Date:   03.18.2003
//  Description:
//    This is a class that represent the container of task classes.
//
//  Modification:
...
/////////////////////////////////////////////////////////////////////
//
// taskManager.java : For task object container manipulation
//
...
import oct.pst.PstUserAbstractObject;
 ...
 /**
  *
  * <b>General Description:</b>  taskManager extends PstManager.  This class
  * manages all task objects such as creating, retrieving, saving, and
  * deleting task objects.
  *
  * taskManager can only instantiated through the getInstance() method.
  *
  *
...
public class taskManager extends oct.pst.PstManager

{
    public static final String NAME = "task";     // The orgname of Object task
    public static final String CLASSNAME = "oct.codegen.task";     // The className of Object task
     ...
     */
    private taskManager(PstUserAbstractObject user)
    ...
    /**
     * Instantiates a taskManager object.
        ...
        throws PmpManagerCreationException, PmpInternalException
    {
        if(manager == null)
        {
            manager = new taskManager(PstSystem.getInstance());
        }
        return manager;
    }//End getInstance
     ...
     * @param user The PstUserAbstractObject who is requesting to create a task.
     * @param type The type of task to create.<br>
     * @param taskName The name of the task.
     *
     * @exception PmpObjectCreationException There was an error creating the task.
     * @exception PmpIllegalTypeException The specified compnaytype is invalid.
     * @return The data object that was created.  An explicit cast is required to convert to a task object.
     */
    public PstAbstractObject create(PstUserAbstractObject user, String taskName)
        throws PmpIllegalTypeException, PmpObjectCreationException
    {
        return create(user.getSession(), taskName);
    }//End create
     ...
     * @param taskName The name of the task.
     * @exception PmpObjectCreationException There was an error creating the task.
     * @exception PmpIllegalTypeException The specified task type is invalid.
     * @return The data object that was created.  An explicit cast is required to convert to a task object.
     */
    PstAbstractObject create(OmsSession session, String taskName)
        throws PmpIllegalTypeException, PmpObjectCreationException
    {
        task task = null;
        if(taskName == null || taskName.length() == 0)
        {
            throw new PmpObjectCreationException("The task name cannot be empty.");
        }

        try
        {

            task = new task(session,m_organization, taskName);
            return task;
        }
        catch(PmpException pe)
        {
            ...
            throw new PmpObjectCreationException("Error creating task object:" + pe.toString());
        }
    }//End create
    	...
    	throws PmpObjectCreationException, PmpInternalException
    {
		...
		try
		{
			newUser = new task(user, m_organization, memberName, password);
		}
		catch(PmpException e)
		{
			throw new PmpObjectCreationException("Cannot create new task");
		}
    	...
    	throws PmpObjectCreationException, PmpInternalException
    {
		...
		try
		{
			newUser = new task(user, m_organization);
		}
		catch(PmpException e)
		{
			throw new PmpObjectCreationException("Cannot create new task");
    ...
    /**
     *
     * Obtain a task object from database.
     * @param user  PstUserAbstractObject requesting a task object.
     * @param objectId Object id of the task object.
     ...
     * @return The data object with the specified id.  An explicit cast is required to convert to a task object.
     */
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        try
        {
            ...
            {
                throw new PmpObjectNotFoundException("Member not in task organization.");
            }
    ...
    /**
     *
     * Obtain a task object from the database.
     * @param user  A PstUserAbstractObject.
     * @param objectName Object name of the task object.
     * @exception PmpObjectNotFoundException Could not find the specified object.
     * @exception PmpInternalException An internal error occurred.
     * @return The data object with the specified id.  An explicit cast is required to convert to a task object.
     */
    ...
    /**
     *
     * Obtain an array of task objects based on a set of specified object ids.
     * @param user  PstUserAbstractObject requesting the task objects.
     * @param objectIds Object ids of all task objects to retrieve.
     ...
     *  the data object to a task object.
     *   <b>NOTE:</b>  The arrays of task will be sorted by object ids,
    ...
    /**
     *
     * Obtain a Company object based on a set of task ids.
     * Obtain an array of task objects based on a set of specified object ids.
     * @param session  PstUserAbstractObject requesting the task objects.
     * @param objectIds Object ids of all task objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        try
        {
            ...
            task [] result = new task[newCount];

            for(int i=0; i<newCount; i++)
            {
                OmsMember member = (OmsMember) memList.get(i);
                //Return a task object
                result[i] = new task(member);
    ...
    /**
     *
     * Obtain an array of task objects based on a set of specified task member names.
     * @param session  PstUserAbstractObject requesting the task objects.
     * @param objectNames Object names of all task objects to retrieve.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An array of data objects with the specified ids.  An explicit cast is required to convert
     *  the data object to a task object.
        ...
        throws PmpObjectNotFoundException, PmpInternalException
    {
        ...
        task [] newResult = new task[newCount];
        for(int i=0; i<newCount; i++)
        {
            newResult[i] = (task) result.get(i);
        }
     ...
     * @param dataObject The task object to delete permanently.
     ...
     * @param dataObject The task object to save.
     ...
     * @param dataObject The task object to refresh.
     */
    public void refresh(PstAbstractObject dataObject)
    {
        ((task)dataObject).refresh();

    }//End refresh


    /**
     * Obtain a List of task objects based on on the user ID.
     *
     * @param user  PstUserAbstractObject requesting the task objects.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An List of task objects that is own by this user.
     *
     */
    public List getAlltask(PstUserAbstractObject user)
        throws PmpObjectNotFoundException, PmpInternalException
    {
    ...
    /**
     * Obtain a List of task objects that belongs to the task.
     *
     * @param projID - int value of a task ID.
     * @param user - PstUserAbstractObject requesting the task objects.
     * @exception PmpObjectNotFoundException Could not find the specified object(s).
     * @exception PmpInternalException An internal error occurred.
     * @return An List of task objects that is own by this user.
     *
     */
    public List getAlltask(PstUserAbstractObject user, int projID)
        throws PmpObjectNotFoundException, PmpInternalException
    {
		List taskList = new ArrayList();
