...
function drawNodes()
{
    ...
    // =============================
    // check node status
    checkStatus(ipAddr);				// check and output status (ajax)
...
function fire()
{
	...
	totalCheckNum = 0;
	for (i=0; i<totalNodes; i++) {if (cImg[i].txLines[0] == 'Ready') {totalCheckNum++;}}
...
<!-- Canvas -->
	...
	<td colspan='2' width='100%'>
		<canvas id="ommCanvas" width='1000' height='<%=canvasHeight%>' style="border:0px solid #555555;">
		</canvas>
	</td></tr>
